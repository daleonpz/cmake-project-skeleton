...
#include "../Components/ft5336/ft5336.h"
	...
	/** @defgroup STM32746G_DISCOVERY_TS_Exported_Constants STM32746G_DISCOVERY_TS Exported
	 * Constants
	 * @{
	 */
...
#define TS_SWAP_XY ((uint8_t)0x08)
	...
	typedef struct
	{
		...
		uint8_t touchWeight[TS_MAX_NB_TOUCH]; /*!< Touch_Weight[0], Touch_Weight[1] : weight
												 property of touches */
		uint8_t touchEventId[TS_MAX_NB_TOUCH]; /*!< Touch_EventId[0], Touch_EventId[1] : take value
												  of type @ref TS_TouchEventTypeDef */
		uint8_t touchArea[TS_MAX_NB_TOUCH]; /*!< Touch_Area[0], Touch_Area[1] : touch area of each
											   touch */
		uint32_t gestureId; /*!< type of gesture detected : take value of type @ref
							   TS_GestureIdTypeDef */
	...
	/** @defgroup STM32746G_DISCOVERY_TS_Imported_Variables STM32746G_DISCOVERY_TS Imported
	 * Variables
	 * @{
	 */
	/**
