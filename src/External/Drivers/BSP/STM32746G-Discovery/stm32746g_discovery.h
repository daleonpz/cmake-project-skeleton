...
#include "stm32f7xx_hal.h"
	...
	/** @defgroup STM32746G_DISCOVERY_LOW_LEVEL_Exported_Types STM32746G_DISCOVERY_LOW_LEVEL
	 * Exported Types
	 * @{
	 */
	typedef enum
...
/** @defgroup STM32746G_DISCOVERY_LOW_LEVEL_Exported_Constants STM32746G_DISCOVERY_LOW_LEVEL
 * Exported Constants
 * @{
 */
...
#define BUTTONx_GPIO_CLK_DISABLE(__INDEX__)                  \
	(((__INDEX__) == 0) ? WAKEUP_BUTTON_GPIO_CLK_DISABLE() : \
	 ((__INDEX__) == 1) ? TAMPER_BUTTON_GPIO_CLK_DISABLE() : \
...
#define DISCOVERY_COMx_CLK_DISABLE(__INDEX__) \
	(((__INDEX__) == 0) ? DISCOVERY_COM1_CLK_DISABLE() : 0)
...
#define DISCOVERY_COMx_TX_GPIO_CLK_DISABLE(__INDEX__) \
	(((__INDEX__) == 0) ? DISCOVERY_COM1_TX_GPIO_CLK_DISABLE() : 0)
...
#define DISCOVERY_COMx_RX_GPIO_CLK_DISABLE(__INDEX__) \
	(((__INDEX__) == 0) ? DISCOVERY_COM1_RX_GPIO_CLK_DISABLE() : 0)
...
/* 0x40912732 takes in account the big rising and aims a clock of 100khz */
	...
	/** @defgroup STM32746G_DISCOVERY_LOW_LEVEL_Exported_Macros STM32746G_DISCOVERY_LOW_LEVEL
	 * Exported Macros
	 * @{
	 */
	/**
