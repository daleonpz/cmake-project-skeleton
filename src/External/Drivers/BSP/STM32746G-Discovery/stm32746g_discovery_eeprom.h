...
/** @defgroup STM32746G_DISCOVERY_EEPROM_Exported_Constants STM32746G_DISCOVERY_EEPROM Exported
 * Constants
 * @{
 */
...
#define EEPROM_TIMEOUT ((uint32_t)2)
	...
	/** @defgroup STM32746G_DISCOVERY_EEPROM_Exported_Macros STM32746G_DISCOVERY_EEPROM Exported
	 * Macros
	 * @{
	 */
	/**
