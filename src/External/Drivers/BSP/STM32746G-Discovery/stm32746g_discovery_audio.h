...
/** @defgroup STM32746G_DISCOVERY_AUDIO_Exported_Constants STM32746G_DISCOVERY_AUDIO Exported
 * Constants
 * @{
 */
...
#define AUDIO_OUT_IRQ_PREPRIO \
	((uint32_t)0x0E) /* Select the preemption priority level(0 is the highest) */
...
#define AUDIO_IN_IRQ_PREPRIO \
	((uint32_t)0x0F) /* Select the preemption priority level(0 is the highest) */
...
#define OUTPUT_DEVICE_HEADPHONE2 \
	OUTPUT_DEVICE_SPEAKER /* Headphone2 is connected to Speaker output of the wm8994 */

	/**
	 * @}
	 */

	/** @defgroup STM32746G_DISCOVERY_AUDIO_Exported_Variables STM32746G_DISCOVERY_AUDIO Exported
	 * Variables
	 * @{
	 */
...
#define DMA_MAX(x) (((x) <= DMA_MAX_SZE) ? (x) : DMA_MAX_SZE)
	...
	/** @defgroup STM32746G_DISCOVERY_AUDIO_IN_Exported_Functions STM32746G_DISCOVERY_AUDIO_IN
	 * Exported Functions
	 * @{
	 */
