...
/** @defgroup STM32746G_DISCOVERY_SD_Private_TypesDefinitions STM32746G_DISCOVERY_SD Private Types
 * Definitions
 * @{
 */
/**
...
/** @defgroup STM32746G_DISCOVERY_SD_Private_FunctionPrototypes STM32746G_DISCOVERY_SD Private
 * Function Prototypes
 * @{
 */
/**
...
{
	return ((HAL_SD_GetCardState(&uSdHandle) == HAL_SD_CARD_TRANSFER) ? SD_TRANSFER_OK :
																		SD_TRANSFER_BUSY);
}
