...
/** @defgroup STM32746G_DISCOVERY_QSPI_Exported_Functions STM32746G_DISCOVERY QSPI Exported
 * Functions
 * @{
 */
...
uint8_t BSP_QSPI_GetStatus(void)
{
	...
	if((reg &
		(N25Q128A_FSR_PRERR | N25Q128A_FSR_VPPERR | N25Q128A_FSR_PGERR | N25Q128A_FSR_ERERR)) != 0)
	{
		return QSPI_ERROR;
	}
