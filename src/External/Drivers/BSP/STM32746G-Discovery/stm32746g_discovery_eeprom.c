  ...
  ******************************************************************************
  @verbatim
			...
			@note   Regarding BSP_EEPROM_WritePage(), it is an optimized function to perform
				   small write (less than 1 page) BUT the number of bytes (combined to write start
  address) must not cross the EEPROM page boundary. This function can only writes into the
  boundaries of an EEPROM page. This function doesn't check on boundaries condition (in this driver
...
/** @defgroup STM32746G_DISCOVERY_EEPROM_Private_Variables STM32746G_DISCOVERY_EEPROM Private
 * Variables
 * @{
 */
...
/** @defgroup STM32746G_DISCOVERY_EEPROM_Private_Function_Prototypes STM32746G_DISCOVERY_EEPROM
...
/** @defgroup STM32746G_DISCOVERY_EEPROM_Exported_Functions STM32746G_DISCOVERY_EEPROM Exported
 * Functions
 * @{
 */
