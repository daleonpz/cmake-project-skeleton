 ...
 */
	...
	defined(HAL_NAND_MODULE_ENABLED) || defined(HAL_SDRAM_MODULE_ENABLED)
												   ...
												   uint32_t Bank)
{
	...
	MODIFY_REG(Device->PMEM, PMEM_CLEAR_MASK,
			   (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PMEM_MEMWAIT3_Pos) |
													  ...
													  uint32_t Bank)
{
	...
	MODIFY_REG(Device->PATT, PATT_CLEAR_MASK,
			   (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PATT_ATTWAIT3_Pos) |
										...
										uint32_t Bank)
{
	...
	{
		MODIFY_REG(Device->SDTR[FMC_SDRAM_BANK1], FMC_SDTR1_TRC | FMC_SDTR1_TRP,
				   (((Timing->RowCycleDelay) - 1U) << FMC_SDTR1_TRC_Pos) |
					   (((Timing->RPDelay) - 1U) << FMC_SDTR1_TRP_Pos));
