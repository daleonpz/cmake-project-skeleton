...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
	   ...
	   ((PeriphClkInit->PeriphClockSelection & RCC_PERIPHCLK_PLLI2S) == RCC_PERIPHCLK_PLLI2S))
	{
			...
			(PeriphClkInit->I2sClockSelection == RCC_I2SCLKSOURCE_PLLI2S)))
		{
			...
			__HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SN, tmpreg0, tmpreg1,
	...
	if(pllsaiused == 1)
	{
		...
		if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) == (RCC_PERIPHCLK_LTDC))
		{
			...
			__HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, tmpreg1, tmpreg0,
	...
	if(PeriphClk == RCC_PERIPHCLK_SAI1)
	{
		...
		switch(saiclocksource)
		{
			case 0: /* PLLSAI is the clock source for SAI1 */
			{
				...
				frequency =
					(vcoinput * ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIN) >> 6)) / (tmpreg);
			...
			case RCC_DCKCFGR1_SAI1SEL_0: /* PLLI2S is the clock source for SAI1 */
			{
				...
				frequency =
					(vcoinput * ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SN) >> 6)) / (tmpreg);
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLI2S(RCC_PLLI2SInitTypeDef* PLLI2SInit)
{
	...
	/* I2SQCLK = PLLI2S_VCO / PLLI2SQ */
	/* I2SRCLK = PLLI2S_VCO / PLLI2SR */
	__HAL_RCC_PLLI2S_CONFIG(PLLI2SInit->PLLI2SN, PLLI2SInit->PLLI2SP, PLLI2SInit->PLLI2SQ,
							PLLI2SInit->PLLI2SR);
	#endif /* STM32F722xx || STM32F723xx || STM32F732xx || STM32F733xx || STM32F730xx */
