/**
  ...
  ******************************************************************************
  ...
  defined as weak (surcharged) functions. They must be defined by the user to be resorted to.
 ...
 * @{
 */
static void DMA2D_SetConfig(DMA2D_HandleTypeDef* hdma2d, uint32_t pdata, uint32_t DstAddress,
		...
		switch(CallbackID)
		{
			...
			case HAL_DMA2D_MSPDEINIT_CB_ID:
				hdma2d->MspDeInitCallback =
					HAL_DMA2D_MspDeInit; /* Legacy weak (surcharged) Msp DeInit */
				break;
