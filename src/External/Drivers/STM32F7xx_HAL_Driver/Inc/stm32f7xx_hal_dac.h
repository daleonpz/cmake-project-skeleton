...
#include "stm32f7xx_hal_def.h"
	...
	#define DAC_TRIGGER_NONE                                                                      \
		0x00000000UL /*!< Conversion is automatic once the DAC1_DHRxxxx register has been loaded, \
	...
	#define DAC_TRIGGER_EXT_IT9                                                                    \
		(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TEN1) /*!< EXTI Line9 event selected as external \
														   conversion trigger for DAC channel */
	#define DAC_TRIGGER_SOFTWARE                                                                 \
		(DAC_CR_TSEL1 | DAC_CR_TEN1) /*!< Conversion started by software trigger for DAC channel \
									  */
