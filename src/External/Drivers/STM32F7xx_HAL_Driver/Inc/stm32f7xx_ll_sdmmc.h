...
extern "C"
{
	...
	typedef struct
	{
		...
		uint32_t
			ClockDiv; /*!< Specifies the clock frequency of the SDMMC controller.
	...
	typedef struct
	{
		...
		uint32_t
			DataBlockSize; /*!< Specifies the data block size for block transfer.
								This parameter can be a value of @ref SDMMC_LL_Data_Block_Size    */

		uint32_t
			TransferDir; /*!< Specifies the data transfer direction, whether the transfer
							  is a read or write.
	...
	#define CLKCR_CLEAR_MASK                                                       \
		((uint32_t)(SDMMC_CLKCR_CLKDIV | SDMMC_CLKCR_PWRSAV | SDMMC_CLKCR_BYPASS | \
					SDMMC_CLKCR_WIDBUS | SDMMC_CLKCR_NEGEDGE | SDMMC_CLKCR_HWFC_EN))
	...
	#define CMD_CLEAR_MASK                                                        \
		((uint32_t)(SDMMC_CMD_CMDINDEX | SDMMC_CMD_WAITRESP | SDMMC_CMD_WAITINT | \
					SDMMC_CMD_WAITPEND | SDMMC_CMD_CPSMEN | SDMMC_CMD_SDIOSUSPEND))
	...
	#define __SDMMC_SUSPEND_CMD_DISABLE(__INSTANCE__) \
		((__INSTANCE__)->CMD &= ~SDMMC_CMD_SDIOSUSPEND)
