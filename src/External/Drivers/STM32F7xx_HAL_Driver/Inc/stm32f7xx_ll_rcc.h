...
#include "stm32f7xx.h"
	 ...
	 */
		...
		#define LL_RCC_CEC_CLKSOURCE_LSE                            \
			0x00000000U /*!< LSE oscillator clock used as CEC clock \
						 */
	...
	#define LL_RCC_SDMMC1_CLKSOURCE RCC_DCKCFGR2_SDMMC1SEL /*!< SDMMC1 Clock source selection */
		...
		#define LL_RCC_SDMMC2_CLKSOURCE                               \
			RCC_DCKCFGR2_SDMMC2SEL /*!< SDMMC2 Clock source selection \
									*/
	#endif /* SDMMC2 */
	/**
	 * @}
	 ...
	 */
		...
		#define LL_RCC_DFSDM1_CLKSOURCE                              \
			RCC_DCKCFGR1_DFSDM1SEL /*!< DFSDM Clock source selection \
									*/
	/**
	 * @}
	 */
	 ...
	 */
	#define __LL_RCC_CALC_PLLI2S_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLI2SN__, __PLLI2SQ__, \
										  __PLLI2SDIVQ__)                                    \
		 ...
		 * @retval PLLI2S clock frequency (in Hz)
		 */
		#define __LL_RCC_CALC_PLLI2S_SPDIFRX_FREQ(__INPUTFREQ__, __PLLM__, __PLLI2SN__, \
												  __PLLI2SP__)                          \
			(((__INPUTFREQ__) / (__PLLM__)) * (__PLLI2SN__) /                           \
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_RCC_PLLI2S_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_RCC_PLLI2S_ConfigDomain_I2S(uint32_t Source, uint32_t PLLM,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_RCC_PLLSAI_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM,
														uint32_t PLLN, uint32_t PLLQ,
														uint32_t PLLDIVQ)
	{
		MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_RCC_PLLSAI_ConfigDomain_48M(uint32_t Source, uint32_t PLLM,
														uint32_t PLLN, uint32_t PLLP)
	{
		MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_RCC_PLLSAI_ConfigDomain_LTDC(uint32_t Source, uint32_t PLLM,
														 uint32_t PLLN, uint32_t PLLR,
														 uint32_t PLLDIVR)
	{
		MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
