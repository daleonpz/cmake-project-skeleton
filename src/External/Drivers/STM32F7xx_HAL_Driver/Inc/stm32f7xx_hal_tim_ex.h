 ...
 */
	...
	#define TIM_BREAKINPUTSOURCE_DFSDM1                                                         \
		(0x00000008U) /* !< The analog watchdog output of the DFSDM1 peripheral is connected to \
						 the break input */
	/**
	 * @}
	 */
...
#define IS_TIM_REMAP(__TIM_REMAP__)                                                        \
	(((__TIM_REMAP__) == TIM_TIM2_TIM8_TRGO) || ((__TIM_REMAP__) == TIM_TIM2_ETH_PTP) ||   \
	 ((__TIM_REMAP__) == TIM_TIM2_USBFS_SOF) || ((__TIM_REMAP__) == TIM_TIM2_USBHS_SOF) || \
	 ((__TIM_REMAP__) == TIM_TIM5_GPIO) || ((__TIM_REMAP__) == TIM_TIM5_LSI) ||            \
	 ((__TIM_REMAP__) == TIM_TIM5_LSE) || ((__TIM_REMAP__) == TIM_TIM5_RTC) ||             \
	 ((__TIM_REMAP__) == TIM_TIM11_GPIO) || ((__TIM_REMAP__) == TIM_TIM11_SPDIFRX) ||      \
	 ((__TIM_REMAP__) == TIM_TIM11_HSE) || ((__TIM_REMAP__) == TIM_TIM11_MCO1))
#if defined(TIM_BREAK_INPUT_SUPPORT)
