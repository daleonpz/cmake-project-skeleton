...
#include "stm32f7xx.h"
	 ...
	 * @note   I/O mode can be Input mode, General purpose output, Alternate function mode or
	 * Analog.
	...
	/**
	 * @brief  Configure gpio alternate function of a dedicated pin from 0 to 7 for a dedicated
	 * port.
	...
	/**
	 * @brief  Configure gpio alternate function of a dedicated pin from 8 to 15 for a dedicated
	 * port.
	 * @note   Possible values are from AF0 to AF15 depending on target.
	 * @note   Warning: only one pin can be passed as parameter.
	...
	/**
	 * @brief  Return 1 if all pins passed as parameter, of a dedicated port, are locked. else
	 * Return 0.
