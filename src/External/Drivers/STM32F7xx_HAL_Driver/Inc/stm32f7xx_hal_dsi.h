...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			VSPolarity; /*!< VSYNC pin polarity
							 This parameter can be any value of @ref DSI_VSYNC_Active_Polarity  */

		uint32_t
			DEPolarity; /*!< Data Enable pin polarity
		...
		uint32_t
			HorizontalBackPorch; /*!< Horizontal back-porch duration (in lane byte clock cycles) */
		...
		uint32_t
			LPHorizontalBackPorchEnable; /*!< Low-power horizontal back-porch enable
		...
		uint32_t
			LPVerticalFrontPorchEnable; /*!< Low-power vertical front-porch enable
											 This parameter can be any value of @ref DSI_LP_VFP */

		uint32_t
			LPVerticalBackPorchEnable; /*!< Low-power vertical back-porch enable
	...
	typedef struct
	{
		...
		uint32_t
			CommandSize; /*!< Maximum allowed size for an LTDC write memory command, measured in
		...
		uint32_t
			AutomaticRefresh; /*!< Automatic refresh mode
	...
	typedef struct
	{
		...
		uint32_t
			LPMaxReadPacket; /*!< Maximum Read Packet Size Transmission
