...
#include "stm32f7xx_hal_def.h"
	...
	{
		uint32_t
			Attributes; /*!< Tx packet HW features capabilities.
		...
		uint32_t
			CRCPadCtrl; /*!< Specifies the CRC and Pad insertion and replacement control.
	...
	typedef struct
	{
		...
		uint32_t
			InterPacketGapVal; /*!< Sets the minimum IPG between Packet during transmission.
		...
		FunctionalState
			CRCStripTypePacket; /*!< Enables or disables the CRC stripping for Type packets.*/

		FunctionalState
			AutomaticPadCRCStrip; /*!< Enables or disables  the Automatic MAC Pad/CRC Stripping.*/
		...
		FunctionalState
			CarrierSenseDuringTransmit; /*!< Enables or disables the Carrier Sense During
		...
		FunctionalState
			CRCCheckingRxPackets; /*!< Enable or disables the CRC Checking for Received Packets. */
		...
		FunctionalState
			ExtendedInterPacketGap; /*!< Enable or disables the extended inter packet gap. */
		...
		uint32_t
			WatchdogTimeout; /*!< This field is used as watchdog timeout for a received packet
		...
		uint32_t
			ReceiveQueueMode; /*!< Specifies the Receive Queue operating mode.
	...
	typedef struct
	{
		...
		FunctionalState
			AddressAlignedBeats; /*!< Enables or disables the AHB Master interface address aligned
		...
		FunctionalState DropTCPIPChecksumErrorFrame; /*!< Selects or not the Dropping of TCP/IP
														Checksum Error Frames */

		FunctionalState
			ReceiveStoreForward; /*!< Enables or disables the Receive store and forward mode */
		...
		FunctionalState
			ForwardErrorFrames; /*!< Selects or not the forward to the DMA of erroneous frames */
		...
		FunctionalState
			SecondFrameOperate; /*!< Selects or not the Operate on second frame mode, which allows
								   the DMA to process a second frame of Transmit data even before
	...
	typedef struct
	{
		...
		FunctionalState
			SrcAddrInverseFiltering; /*!< Enable or Disable source address inverse filtering */
	...
	{
		FunctionalState
			WakeUpPacket; /*!< Enable or Disable Wake up packet detection in power down mode */

		FunctionalState
			MagicPacket; /*!< Enable or Disable Magic packet detection in power down mode */
	...
	*/
	...
	#define ETH_DMATXDESC_ES                                                                     \
		0x00008000U /*!< Error summary: OR of the following bits: UE || ED || EC || LCO || NC || \
					   LCA || FF || JT */
	#define ETH_DMATXDESC_JT 0x00004000U /*!< Jabber Timeout */
	#define ETH_DMATXDESC_FF \
		0x00002000U /*!< Frame Flushed: DMA/MTL flushed the frame due to SW flush */
	...
	#define ETH_DMATXDESC_UF                                                \
		0x00000002U /*!< Underflow Error: late data arrival from the memory \
					 */
	...
	*/
	...
	#define ETH_DMARXDESC_ES                                                                      \
		0x00008000U /*!< Error summary: OR of the following bits: DE || OE || IPC || LC || RWT || \
					   RE || CE */
	#define ETH_DMARXDESC_DE \
		0x00004000U /*!< Descriptor error: no more descriptors for receive frame  */
	...
	#define ETH_DMARXDESC_OE \
		0x00000800U /*!< Overflow Error: Frame was damaged due to buffer overflow */
	...
	#define ETH_DMARXDESC_IPV4HCE \
		0x00000080U /*!< IPC Checksum Error: Rx Ipv4 header checksum error   */
	...
	#define ETH_DMARXDESC_DBE \
		0x00000004U /*!< Dribble bit error: frame contains non int multiple of 8 bits  */
	#define ETH_DMARXDESC_CE 0x00000002U /*!< CRC error */
	#define ETH_DMARXDESC_MAMPCE                                                                   \
		0x00000001U /*!< Rx MAC Address/Payload Checksum Error: Rx MAC address matched/ Rx Payload \
					   Checksum Error */
	...
	#define ETH_TXDMABURSTLENGTH_1BEAT                                                    \
		0x00000100U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 1 */
	#define ETH_TXDMABURSTLENGTH_2BEAT                                                    \
		0x00000200U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 2 */
	#define ETH_TXDMABURSTLENGTH_4BEAT                                                    \
		0x00000400U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 4 */
	#define ETH_TXDMABURSTLENGTH_8BEAT                                                    \
		0x00000800U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 8 */
	#define ETH_TXDMABURSTLENGTH_16BEAT                                                   \
		0x00001000U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 16 */
	#define ETH_TXDMABURSTLENGTH_32BEAT                                                   \
		0x00002000U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 32 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_4BEAT                                              \
		0x01000100U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 4 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_8BEAT                                              \
		0x01000200U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 8 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_16BEAT                                             \
		0x01000400U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 16 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_32BEAT                                             \
		0x01000800U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 32 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_64BEAT                                             \
		0x01001000U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 64 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_128BEAT                                            \
		0x01002000U /*!< maximum number of beats to be transferred in one TxDMA (or both) \
					   transaction is 128 */
	/**
	 * @}
	 */
	...
	#define ETH_DMA_RX_DESC_READ_ERROR_FLAG \
		(ETH_DMACSR_REB_BIT_2 | ETH_DMACSR_REB_BIT_1 | ETH_DMACSR_REB_BIT_0)
	...
	#define ETH_DMA_TX_DESC_READ_ERROR_FLAG \
		(ETH_DMACSR_TEB_BIT_2 | ETH_DMACSR_TEB_BIT_1 | ETH_DMACSR_TEB_BIT_0)
	...
	#define ETH_PASSCONTROLFRAMES_FORWARDALL                                                  \
		0x00000080U /*!< MAC forwards all control frames to application even if they fail the \
					   Address Filter */
	...
	#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT                                               \
		0x00800000U /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be \
					   present */
	...
	#define ETH_MMC_IT_TGF \
		0x00200000U /*!< When Tx good frame counter reaches half the maximum value */
	#define ETH_MMC_IT_TGFMSC \
		0x00008000U /*!< When Tx good multi col counter reaches half the maximum value */
	#define ETH_MMC_IT_TGFSC \
		0x00004000U /*!< When Tx good single col counter reaches half the maximum value */
	/**
	 * @}
	 */
	...
	#define ETH_MMC_IT_RFAE \
		0x10000040U /*!< When Rx alignment error counter reaches half the maximum value */
	#define ETH_MMC_IT_RFCE \
		0x10000020U /*!< When Rx crc error counter reaches half the maximum value */
	/**
	 * @}
	 */
	...
	#define ETH_DMA_FLAG_READWRITEERROR \
		0x01000000U /*!< Error bits 0-write transfer, 1-read transfer */
	...
	#define ETH_DMA_OVERFLOW_RXFIFOCOUNTER \
		0x10000000U /*!< Overflow bit for FIFO overflow counter */
	#define ETH_DMA_OVERFLOW_MISSEDFRAMECOUNTER \
		0x00010000U /*!< Overflow bit for missed frame counter */
	/**
	 * @}
	 */
	...
	#define __HAL_ETH_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
		(((__HANDLE__)->Instance->DMAIER & (__INTERRUPT__)) == (__INTERRUPT__))
	...
	#define __HAL_ETH_DMA_GET_IT(__HANDLE__, __INTERRUPT__) \
		(((__HANDLE__)->Instance->DMASR & (__INTERRUPT__)) == (__INTERRUPT__))
	...
	#define __HAL_ETH_MAC_GET_IT(__HANDLE__, __INTERRUPT__) \
		(((__HANDLE__)->Instance->MACSR & (__INTERRUPT__)) == (__INTERRUPT__))
	...
	#define __HAL_ETH_GET_PTP_CONTROL(__HANDLE__, __FLAG__) \
		(((((__HANDLE__)->Instance->PTPTSCR) & (__FLAG__)) == (__FLAG__)) ? SET : RESET)
	...
	HAL_StatusTypeDef
		HAL_ETH_RegisterRxAllocateCallback(ETH_HandleTypeDef* heth,
	...
	HAL_StatusTypeDef HAL_ETH_Transmit(ETH_HandleTypeDef* heth, ETH_TxPacketConfig* pTxConfig,
									   uint32_t Timeout);
	HAL_StatusTypeDef HAL_ETH_Transmit_IT(ETH_HandleTypeDef* heth, ETH_TxPacketConfig* pTxConfig);

	HAL_StatusTypeDef HAL_ETH_WritePHYRegister(ETH_HandleTypeDef* heth, uint32_t PHYAddr,
	...
	HAL_StatusTypeDef HAL_ETH_SetWakeUpFilter(ETH_HandleTypeDef* heth, uint32_t* pFilter,
											  uint32_t Count);
