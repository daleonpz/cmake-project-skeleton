...
#include "stm32f7xx_hal_def.h"
	...
	#define LTDC_BLENDING_FACTOR1_PAxCA                      \
		0x00000600U /*!< Blending factor : Cte Alpha x Pixel \
					   Alpha*/
	/**
	 * @}
	 */
	...
	#define LTDC_BLENDING_FACTOR2_PAxCA                      \
		0x00000007U /*!< Blending factor : Cte Alpha x Pixel \
					   Alpha*/
	/**
	 * @}
	 */
	...
	HAL_StatusTypeDef HAL_LTDC_SetWindowSize(LTDC_HandleTypeDef* hltdc, uint32_t XSize,
											 uint32_t YSize, uint32_t LayerIdx);
	HAL_StatusTypeDef HAL_LTDC_SetWindowPosition(LTDC_HandleTypeDef* hltdc, uint32_t X0,
	...
	HAL_StatusTypeDef HAL_LTDC_SetAlpha(LTDC_HandleTypeDef* hltdc, uint32_t Alpha,
										uint32_t LayerIdx);
	HAL_StatusTypeDef HAL_LTDC_SetAddress(LTDC_HandleTypeDef* hltdc, uint32_t Address,
										  uint32_t LayerIdx);
	...
	HAL_StatusTypeDef HAL_LTDC_ConfigColorKeying(LTDC_HandleTypeDef* hltdc, uint32_t RGBValue,
												 uint32_t LayerIdx);
	HAL_StatusTypeDef HAL_LTDC_ConfigCLUT(LTDC_HandleTypeDef* hltdc, uint32_t* pCLUT,
	...
	HAL_StatusTypeDef HAL_LTDC_ConfigLayer_NoReload(LTDC_HandleTypeDef* hltdc,
													...
													uint32_t LayerIdx);
	HAL_StatusTypeDef HAL_LTDC_SetWindowSize_NoReload(LTDC_HandleTypeDef* hltdc, uint32_t XSize,
													  uint32_t YSize, uint32_t LayerIdx);
	HAL_StatusTypeDef HAL_LTDC_SetWindowPosition_NoReload(LTDC_HandleTypeDef* hltdc, uint32_t X0,
														  uint32_t Y0, uint32_t LayerIdx);
