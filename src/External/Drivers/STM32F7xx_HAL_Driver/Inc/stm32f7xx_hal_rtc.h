...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t SecondFraction; /*!< Specifies the range or granularity of Sub Second register
									content corresponding to Synchronous prescaler factor value
...
#define RTC_DR_RESERVED_MASK \
	((uint32_t)(RTC_DR_YT | RTC_DR_YU | RTC_DR_MT | RTC_DR_MU | RTC_DR_DT | RTC_DR_DU | RTC_DR_WDU))
#define RTC_INIT_MASK 0xFFFFFFFFU
#define RTC_RSF_MASK ((uint32_t) ~(RTC_ISR_INIT | RTC_ISR_RSF))
#define RTC_FLAGS_MASK                                                                            \
	((uint32_t)(RTC_FLAG_INITF | RTC_FLAG_INITS | RTC_FLAG_ALRAF | RTC_FLAG_ALRAWF |              \
				RTC_FLAG_ALRBF | RTC_FLAG_ALRBWF | RTC_FLAG_WUTF | RTC_FLAG_WUTWF |               \
				RTC_FLAG_RECALPF | RTC_FLAG_SHPF | RTC_FLAG_TSF | RTC_FLAG_TSOVF | RTC_FLAG_RSF | \
