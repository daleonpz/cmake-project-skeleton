...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			TimeOutEnable; /*!< Specifies whether the receiver timeout is enabled.
	...
	typedef struct
	{
		...
		uint32_t
			OverrunDisable; /*!< Specifies whether the reception overrun detection is disabled.
	 ...
	 *             1  : Init done (Peripheral initialized. HAL SMARTCARD Init function already
	...
	typedef struct __SMARTCARD_HandleTypeDef
	{
		...
		void (*TxCpltCallback)(
			struct __SMARTCARD_HandleTypeDef* hsmartcard); /*!< SMARTCARD Tx Complete Callback */

		void (*RxCpltCallback)(
			struct __SMARTCARD_HandleTypeDef* hsmartcard); /*!< SMARTCARD Rx Complete Callback */
