...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			PLLQ; /*!< PLLQ: Division factor for OTG FS, SDMMC and RNG clocks.
	...
	typedef struct
	{
		...
		uint32_t PLLI2SQ; /*!< Specifies the division factor for SAI1 clock.
							   This parameter must be a number between Min_Data = 2 and Max_Data
							 = 15. This parameter will be used only when PLLI2S is selected as Clock
							 Source SAI */
	...
	typedef struct
	{
		...
		uint32_t PLLSAIQ; /*!< Specifies the division factor for SAI1 clock.
							   This parameter must be a number between Min_Data = 2 and Max_Data
							 = 15. This parameter will be used only when PLLSAI is selected as Clock
							 Source SAI or LTDC */
	...
	typedef struct
	{
		...
		uint32_t
			I2sClockSelection; /*!< Specifies I2S Clock source Selection.
		...
		uint32_t
			CecClockSelection; /*!< CEC clock source
									This parameter can be a value of @ref RCCEx_CEC_Clock_Source */

		uint32_t Clk48ClockSelection; /*!< Specifies 48Mhz clock source used by USB OTG FS, RNG and
										 SDMMC This parameter can be a value of @ref
