 ...
 */
	...
	HAL_StatusTypeDef HAL_NOR_ReadBuffer(NOR_HandleTypeDef* hnor, uint32_t uwAddress,
	...
	HAL_NOR_StatusTypeDef HAL_NOR_GetStatus(NOR_HandleTypeDef* hnor, uint32_t Address,
											uint32_t Timeout);
/**
 * @}
 */
