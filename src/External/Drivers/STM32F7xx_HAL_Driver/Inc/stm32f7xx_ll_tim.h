...
#include "stm32f7xx.h"
...
#if defined(TIM1) || defined(TIM8) || defined(TIM2) || defined(TIM3) || defined(TIM4) ||    \
	defined(TIM5) || defined(TIM9) || defined(TIM10) || defined(TIM11) || defined(TIM12) || \
	defined(TIM13) || defined(TIM14) || defined(TIM6) || defined(TIM7)
	...
	typedef struct
	{
		...
		uint32_t
			CommutationDelay; /*!< Specifies the compare value to be loaded into the Capture Compare
	...
	typedef struct
	{
		...
		uint32_t
			AutomaticOutput; /*!< Specifies whether the TIM Automatic Output feature is enabled or
	...
	#define LL_TIM_OSSR_ENABLE                                                                    \
		...
		#define LL_TIM_BKIN_SOURCE_DF1BK \
			TIM1_AF1_BKDF1BKE /*!< internal signal: DFSDM1 break output */
		/**
		 * @}
		 */
	...
	#define LL_TIM_TIM2_ITR1_RMP_ETH_PTP \
		(TIM2_OR_ITR1_RMP_0 | TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to ETH_PTP */
	#define LL_TIM_TIM2_ITR1_RMP_OTG_FS_SOF \
		(TIM2_OR_ITR1_RMP_1 | TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to OTG_FS SOF */
	#define LL_TIM_TIM2_ITR1_RMP_OTG_HS_SOF \
		(TIM2_OR_ITR1_RMP | TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to OTG_HS SOF */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TIM5_TI4_RMP_LSE \
		(TIM5_OR_TI4_RMP_1 | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to LSE */
	#define LL_TIM_TIM5_TI4_RMP_RTC \
		(TIM5_OR_TI4_RMP |          \
		 TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to RTC wakeup interrupt */
	/**
	 * @}
	 */
	...
	#define LL_TIM_TIM11_TI1_RMP_SPDIFRX \
		(TIM11_OR_TI1_RMP_0 | TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to SPDIFRX */
	#define LL_TIM_TIM11_TI1_RMP_HSE \
		(TIM11_OR_TI1_RMP_1 | TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to HSE */
	#define LL_TIM_TIM11_TI1_RMP_MCO1 \
		(TIM11_OR_TI1_RMP | TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to MCO1 */
	/**
	 * @}
	 */
	...
	/**
	 * @brief  HELPER macro calculating DTG[0:7] in the TIMx_BDTR register to achieve the requested
	 * dead time duration.
	...
	/**
	 * @brief  Get the actual division ratio between the timer clock  and the sampling clock used by
	 * the dead-time generators (when supported) and the digital filters.
	 * @note Macro IS_TIM_CLOCK_DIVISION_INSTANCE(TIMx) can be used to check
	 *       whether or not the clock division feature is supported by the timer
	 *       instance.
	...
	/**
	 * @brief  Indicates whether compare register (TIMx_CCRx) preload is enabled for the output
	 * channel.
	 ...
	 * @note This function can only be used in Output compare and PWM modes. It does not work in
	 * Forced mode.
	 ...
	 * and the rising edge of the Ocx and OCxN signals).
	 * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
	 *       dead-time insertion feature is supported by a timer instance.
	 * @note Helper macro @ref __LL_TIM_CALC_DEADTIME can be used to calculate the DeadTime
	 * parameter
	 ...
	 * @note When external clock mode 2 is enabled the counter is clocked by any active edge on the
	 * ETRF signal.
	...
	/**
	 * @brief  Enable automatic output (MOE can be set by software or automatically when a break
	 * input is active).
	 * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
	 *       a timer instance provides a break input.
	...
	ErrorStatus
		LL_TIM_HALLSENSOR_Init(TIM_TypeDef* TIMx,
...
#endif /* TIM1 || TIM8 || TIM2 || TIM3 ||  TIM4 || TIM5 ||TIM9 || TIM10 || TIM11 || TIM12 || TIM13 \
		  || TIM14 || TIM6 || TIM7 */
