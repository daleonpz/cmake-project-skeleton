...
#include "stm32f7xx.h"
	...
	typedef struct
	{
		...
		uint32_t
			WaveAutoGenerationConfig; /*!< Set the waveform automatic generation mode for the
										 selected DAC channel. If waveform automatic generation mode
										 is set to noise, this parameter can be a value of @ref
										 DAC_LL_EC_WAVE_NOISE_LFSR_UNMASK_BITS If waveform automatic
										 generation mode is set to triangle, this parameter can be a
										 value of @ref DAC_LL_EC_WAVE_TRIANGLE_AMPLITUDE
	...
	#define LL_DAC_NOISE_LFSR_UNMASK_BITS7_0                                                     \
		(DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 |                                                       \
		 DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR bits[7:0], for the selected DAC \
							channel */
	...
	#define LL_DAC_NOISE_LFSR_UNMASK_BITS10_0                                                     \
		(DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1) /*!< Noise wave generation, unmask LFSR bits[10:0], for \
											 the selected DAC channel */
	#define LL_DAC_NOISE_LFSR_UNMASK_BITS11_0                                                     \
		(DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 |                                                        \
		 DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR bits[11:0], for the selected DAC \
							channel */
	/**
	 * @}
	 */
	...
	#define LL_DAC_TRIANGLE_AMPLITUDE_255                                                         \
		(DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 |                                                        \
		 DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 255 LSB of DAC output range, \
							for the selected DAC channel */
	#define LL_DAC_TRIANGLE_AMPLITUDE_511                                                         \
		(DAC_CR_MAMP1_3) /*!< Triangle wave generation, amplitude of 512 LSB of DAC output range, \
							for the selected DAC channel */
	#define LL_DAC_TRIANGLE_AMPLITUDE_1023                                                        \
		(DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 1023 LSB of \
											 DAC output range, for the selected DAC channel */
	#define LL_DAC_TRIANGLE_AMPLITUDE_2047                                                        \
		(DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1) /*!< Triangle wave generation, amplitude of 2047 LSB of \
											 DAC output range, for the selected DAC channel */
	#define LL_DAC_TRIANGLE_AMPLITUDE_4095                                                         \
		(DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 |                                                         \
		 DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 4095 LSB of DAC output range, \
							for the selected DAC channel */
	/**
	 * @}
	 */
	...
	#define LL_DAC_OUTPUT_BUFFER_DISABLE                                                         \
		(DAC_CR_BOFF1) /*!< The selected DAC channel output is not buffered: lower drive current \
						  capability, but also lower current consumption */
	/**
	 * @}
	 */
	...
	#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                                               \
		15UL /*!< Delay for DAC channel voltage settling time from DAC channel startup (transition \
	...
	#define LL_DAC_DELAY_VOLTAGE_SETTLING_US \
		12UL /*!< Delay for DAC channel voltage settling time */
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DAC_ConvertData12LeftAligned(DAC_TypeDef* DACx, uint32_t DAC_Channel,
														 uint32_t Data)
	{
		__IO uint32_t* preg = __DAC_PTR_REG_OFFSET(
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DAC_ConvertData8RightAligned(DAC_TypeDef* DACx, uint32_t DAC_Channel,
														 uint32_t Data)
	{
		__IO uint32_t* preg = __DAC_PTR_REG_OFFSET(
	...
	__STATIC_INLINE uint32_t LL_DAC_RetrieveOutputData(DAC_TypeDef* DACx, uint32_t DAC_Channel)
	{
		__IO uint32_t const* preg =
			__DAC_PTR_REG_OFFSET(DACx->DOR1, (DAC_Channel >> DAC_REG_DORX_REGOFFSET_BITOFFSET_POS) &
