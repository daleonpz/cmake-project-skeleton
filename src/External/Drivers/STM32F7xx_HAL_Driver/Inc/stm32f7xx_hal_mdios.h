...
#include "stm32f7xx_hal_def.h"
	...
	#endif /* USE_HAL_MDIOS_REGISTER_CALLBACKS */
	{
		...
		void (*WriteCpltCallback)(
			struct __MDIOS_HandleTypeDef* hmdios); /*!< MDIOS Write Complete Callback */
		void (*ReadCpltCallback)(
			struct __MDIOS_HandleTypeDef* hmdios); /*!< MDIOS Read  Complete Callback */
		...
		void (*MspInitCallback)(
			struct __MDIOS_HandleTypeDef* hmdios); /*!< MDIOS Msp Init callback       */
		void (*MspDeInitCallback)(
			struct __MDIOS_HandleTypeDef* hmdios); /*!< MDIOS Msp DeInit callback     */
	 ...
	 */
	typedef void (*pMDIOS_CallbackTypeDef)(
		MDIOS_HandleTypeDef* hmdios); /*!< pointer to an MDIOS callback function */
	 ...
	 * @retval None
	 */
	#define __HAL_MDIOS_WAKEUP_EXTI_ENABLE_RISING_EDGE_TRIGGER() \
	 ...
	 * @retval None
	 */
	#define __HAL_MDIOS_WAKEUP_EXTI_DISABLE_RISING_EDGE_TRIGGER() \
		EXTI->RTSR &= ~(MDIOS_WAKEUP_EXTI_LINE)
	 ...
	 * @retval None
	 */
	#define __HAL_MDIOS_WAKEUP_EXTI_ENABLE_FALLING_EDGE_TRIGGER() \
	 ...
	 * @retval None
	 */
	#define __HAL_MDIOS_WAKEUP_EXTI_DISABLE_FALLING_EDGE_TRIGGER() \
		EXTI->FTSR &= ~(MDIOS_WAKEUP_EXTI_LINE)
