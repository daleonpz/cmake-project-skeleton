...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			Trigger; /*!< Specifies the Tamper Trigger.
		...
		uint32_t
			Filter; /*!< Specifies the RTC Filter Tamper.
...
#define RTC_TAMPER_PULLUP_DISABLE \
	RTC_TAMPCR_TAMPPUDIS /*!< Tamper pins are not pre-charged before sampling */
#define RTC_TAMPER_PULLUP_MASK \
	RTC_TAMPCR_TAMPPUDIS /*!< Masking all bits except bit TAMPPUDIS           */
/**
 * @}
 */

/** @defgroup RTCEx_Tamper_TimeStampOnTamperDetection_Definitions RTCEx Tamper TimeStamp On Tamper
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT                                                      \
	EXTI_IMR_IM21 /*!< External interrupt line 21 Connected to the RTC Tamper and Timestamp event \
				   */
 ...
 */
/* Masks Definition */
#define RTC_TAMPER_ENABLE_BITS_MASK ((uint32_t)(RTC_TAMPER_1 | RTC_TAMPER_2 | RTC_TAMPER_3))

#define RTC_TAMPER_FLAGS_MASK ((uint32_t)(RTC_FLAG_TAMP1F | RTC_FLAG_TAMP2F | RTC_FLAG_TAMP3F))

#define RTC_TAMPER_IT_ENABLE_BITS_MASK \
	((uint32_t)(RTC_IT_TAMP1 | RTC_IT_TAMP2 | RTC_IT_TAMP3 | RTC_IT_TAMP))
/**
 * @}
 */
...
#define IS_RTC_TAMPER_INTERRUPT(INTERRUPT) \
	((((INTERRUPT) & ((uint32_t)~RTC_TAMPER_IT_ENABLE_BITS_MASK)) == 0x00U) && ((INTERRUPT) != 0U))
...
#define IS_RTC_TAMPER_FILTER_CONFIG_CORRECT(FILTER, TRIGGER)                                     \
	((((FILTER) != RTC_TAMPERFILTER_DISABLE) && (((TRIGGER) == RTC_TAMPERTRIGGER_LOWLEVEL) ||    \
												 ((TRIGGER) == RTC_TAMPERTRIGGER_HIGHLEVEL))) || \
	 (((FILTER) == RTC_TAMPERFILTER_DISABLE) && (((TRIGGER) == RTC_TAMPERTRIGGER_RISINGEDGE) ||  \
