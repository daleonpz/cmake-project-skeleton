...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			ExtendedDataMode; /*!< Specifies the data width: 8-bit, 10-bit, 12-bit or 14-bit.
		...
		uint32_t
			ByteSelectStart; /*!< Specifies if the data to be captured by the interface is even or
	...
	#define DCMI_PCKPOLARITY_FALLING \
		((uint32_t)0x00000000U) /*!< Pixel clock active on Falling edge */
	...
	#define DCMI_VSPOLARITY_LOW                                          \
		((uint32_t)0x00000000U) /*!< Vertical synchronization active Low \
								 */
	...
	#define DCMI_HSPOLARITY_LOW \
		((uint32_t)0x00000000U) /*!< Horizontal synchronization active Low  */
	...
	#define DCMI_EXTEND_DATA_8B \
		((uint32_t)0x00000000U) /*!< Interface captures 8-bit data on every pixel clock  */
	...
	#define DCMI_OEBS_ODD                                                                     \
		((uint32_t)0x00000000U) /*!< Interface captures first data from the frame/line start, \
								   second one being dropped */
	#define DCMI_OEBS_EVEN                                                                      \
		((uint32_t)DCMI_CR_OEBS) /*!< Interface captures second data from the frame/line start, \
	...
	#define DCMI_OELS_ODD                                                                       \
		((uint32_t)0x00000000U) /*!< Interface captures first line from the frame start, second \
								   one being dropped */
	#define DCMI_OELS_EVEN                                                                       \
		((uint32_t)DCMI_CR_OELS) /*!< Interface captures second line from the frame start, first \
									one being dropped */
