...
#include "stm32f7xx.h"
	...
	#define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
		(0U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ1) */
	#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
		(5U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ2) */
	#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS \
		(10U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ3) */
	#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS \
		(15U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ4) */
	#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
		(20U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ5) */
	#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
		(25U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ6) */
	#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
		(0U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ7) */
	#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS \
		(5U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ8) */
	#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS \
		(10U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ9) */
	#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS \
		(15U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ10) */
	#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS \
		(20U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ11) */
	#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS \
		(25U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ12) */
	#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS \
		(0U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ13) */
	#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS \
		(5U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ14) */
	#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS \
		(10U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ15) */
	#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS \
		(15U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ16) */
	...
	#define ADC_REG_TRIG_EXT_EDGE_DEFAULT                                                        \
		(ADC_CR2_EXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility  \
	...
	#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS \
		(24U) /* Value equivalent to POSITION_VAL(ADC_CR2_EXTSEL) */
	#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS \
		(28U) /* Value equivalent to POSITION_VAL(ADC_CR2_EXTEN) */
	...
	#define ADC_INJ_TRIG_EXT_EDGE_DEFAULT                                                         \
		(ADC_CR2_JEXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility  \
							  with some ADC on other STM32 families having this setting set by HW \
							  default value) */
	...
	#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS \
		(16U) /* Value equivalent to POSITION_VAL(ADC_CR2_JEXTSEL) */
	#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS \
		(20U) /* Value equivalent to POSITION_VAL(ADC_CR2_JEXTEN) */
	...
	#define ADC_CHANNEL_ID_INTERNAL_CH_2                                                        \
		0x40000000U /* Marker of internal channel for other ADC instances, in case of different \
					   ADC internal channels mapped on same channel number on different ADC     \
					   instances */
	#define ADC_CHANNEL_DIFFERENCIATION_TEMPSENSOR_VBAT                                     \
		0x10000000U /* Dummy bit for driver internal usage, not used in ADC channel setting \
					   registers CR1 or SQRx */
	...
	#define VREFINT_CAL_ADDR                                                                       \
		VREFINT_CAL_ADDR_CMSIS /* Internal voltage reference, address of parameter VREFINT_CAL:    \
								  VrefInt ADC raw data acquired at temperature 30 DegC (tolerance: \
								  +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
	#define VREFINT_CAL_VREF                                                                     \
		(3300U) /* Analog voltage reference (Vref+) value with which temperature sensor has been \
				   calibrated in production (tolerance: +-10 mV) (unit: mV). */
	/* Temperature sensor */
	#define TEMPSENSOR_CAL1_ADDR                                                                 \
		TEMPSENSOR_CAL1_ADDR_CMSIS /* Internal temperature sensor, address of parameter TS_CAL1: \
									  On STM32F7, temperature sensor ADC raw data acquired at    \
									  temperature  30 DegC (tolerance: +-5 DegC), Vref+ = 3.3 V  \
									  (tolerance: +-10 mV). */
	#define TEMPSENSOR_CAL2_ADDR                                                                 \
		TEMPSENSOR_CAL2_ADDR_CMSIS /* Internal temperature sensor, address of parameter TS_CAL2: \
									  On STM32F7, temperature sensor ADC raw data acquired at    \
									  temperature 110 DegC (tolerance: +-5 DegC), Vref+ = 3.3 V  \
									  (tolerance: +-10 mV). */
	#define TEMPSENSOR_CAL1_TEMP                                                                  \
		((int32_t)30) /* Internal temperature sensor, temperature at which temperature sensor has \
	...
	#define TEMPSENSOR_CAL_VREFANALOG                                                              \
		(3300U) /* Analog voltage reference (Vref+) voltage with which temperature sensor has been \
	...
	{
		uint32_t
			CommonClock; /*!< Set parameter common to several ADC: Clock source and prescaler.
	...
	typedef struct
	{
		...
		uint32_t
			SequencersScanMode; /*!< Set ADC scan selection.
	...
	{
		uint32_t
			TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW start)
							  or from external IP (timer event, external interrupt line). This
		...
		uint32_t SequencerLength; /*!< Set ADC group regular sequencer length.
									 ...
									 ADC_LL_EC_REG_SEQ_SCAN_LENGTH
									   @note This parameter is discarded if scan mode is disabled
									 (refer to parameter 'ADC_SequencersScanMode').
		...
		uint32_t DMATransfer; /*!< Set ADC group regular conversion data transfer: no transfer or
								 ...
								 value of @ref ADC_LL_EC_REG_DMA_TRANSFER
	...
	{
		uint32_t
			TriggerSource; /*!< Set ADC group injected conversion trigger source: internal (SW
		...
		uint32_t
			TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC group
	...
	#define LL_ADC_FLAG_EOCS                                                                 \
		ADC_SR_EOC /*!< ADC flag ADC group regular end of unitary conversion or sequence     \
	...
	#define LL_ADC_FLAG_JEOS                                                                     \
		ADC_SR_JEOC /*!< ADC flag ADC group injected end of sequence conversions (Note: on this  \
					   STM32 series, there is no flag ADC group injected end of unitary          \
	...
	#define LL_ADC_FLAG_EOCS_SLV1                                                                \
		ADC_CSR_EOC2 /*!< ADC flag ADC multimode slave 1 group regular end of unitary conversion \
						or sequence conversions (to configure flag of end of conversion, use     \
						function @ref LL_ADC_REG_SetFlagEndOfConversion() ) */
	#define LL_ADC_FLAG_EOCS_SLV2                                                                \
		ADC_CSR_EOC3 /*!< ADC flag ADC multimode slave 2 group regular end of unitary conversion \
						or sequence conversions (to configure flag of end of conversion, use     \
						function @ref LL_ADC_REG_SetFlagEndOfConversion() ) */
	...
	#define LL_ADC_FLAG_JEOS_MST                                                                   \
		ADC_CSR_JEOC1 /*!< ADC flag ADC multimode master group injected end of sequence            \
						 conversions (Note: on this STM32 series, there is no flag ADC group       \
						 injected end of unitary conversion. Flag noted as "JEOC" is corresponding \
						 to flag "JEOS" in other STM32 families) */
	#define LL_ADC_FLAG_JEOS_SLV1                                                                  \
		ADC_CSR_JEOC2 /*!< ADC flag ADC multimode slave 1 group injected end of sequence           \
						 conversions (Note: on this STM32 series, there is no flag ADC group       \
						 injected end of unitary conversion. Flag noted as "JEOC" is corresponding \
						 to flag "JEOS" in other STM32 families) */
	#define LL_ADC_FLAG_JEOS_SLV2                                                                  \
		ADC_CSR_JEOC3 /*!< ADC flag ADC multimode slave 2 group injected end of sequence           \
						 conversions (Note: on this STM32 series, there is no flag ADC group       \
						 injected end of unitary conversion. Flag noted as "JEOC" is corresponding \
						 to flag "JEOS" in other STM32 families) */
	...
	#define LL_ADC_IT_EOCS                                                                 \
		ADC_CR1_EOCIE /*!< ADC interruption ADC group regular end of unitary conversion or \
	...
	#define LL_ADC_IT_JEOS                                                                         \
		ADC_CR1_JEOCIE /*!< ADC interruption ADC group injected end of sequence conversions (Note: \
						  on this STM32 series, there is no flag ADC group injected end of unitary \
						  conversion. Flag noted as "JEOC" is corresponding to flag "JEOS" in      \
	...
	#define LL_ADC_DMA_REG_REGULAR_DATA                                                            \
		0x00000000U /* ADC group regular conversion data register (corresponding to register DR)   \
					   to be used with ADC configured in independent mode. Without DMA transfer,   \
	...
	#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                                     \
		0x00000001U /* ADC group regular conversion data register (corresponding to register CDR) \
					   to be used with ADC configured in multimode (available on STM32 devices    \
					   with several ADC instances). Without DMA transfer, register accessed by LL \
	...
	#define LL_ADC_CLOCK_SYNC_PCLK_DIV4                                                     \
		(ADC_CCR_ADCPRE_0) /*!< ADC synchronous clock derived from AHB clock with prescaler \
							  division by 4 */
	#define LL_ADC_CLOCK_SYNC_PCLK_DIV6                                                     \
		(ADC_CCR_ADCPRE_1) /*!< ADC synchronous clock derived from AHB clock with prescaler \
							  division by 6 */
	#define LL_ADC_CLOCK_SYNC_PCLK_DIV8                                                         \
		(ADC_CCR_ADCPRE_1 | ADC_CCR_ADCPRE_0) /*!< ADC synchronous clock derived from AHB clock \
	...
	#define LL_ADC_DATA_ALIGN_RIGHT                                                               \
		0x00000000U /*!< ADC conversion data alignment: right aligned (alignment on data register \
					   LSB bit 0)*/
	#define LL_ADC_DATA_ALIGN_LEFT                                                          \
		(ADC_CR2_ALIGN) /*!< ADC conversion data alignment: left aligned (alignment on data \
						   register MSB bit 15)*/
	/**
	 * @}
	 */
	...
	#define LL_ADC_SEQ_SCAN_DISABLE                                                               \
		0x00000000U /*!< ADC conversion is performed in unitary conversion mode (one channel      \
					   converted, that defined in rank 1). Configuration of both groups regular   \
					   and injected sequencers (sequence length, ...) is discarded: equivalent to \
					   length of 1 rank.*/
	#define LL_ADC_SEQ_SCAN_ENABLE                                                                \
		(ADC_CR1_SCAN) /*!< ADC conversions are performed in sequence conversions mode, according \
						  to configuration of both groups regular and injected sequencers         \
						  (sequence length, ...). */
	/**
	 * @}
	 */
	...
	#define LL_ADC_GROUP_INJECTED \
		0x00000002U /*!< ADC group injected (not available on all STM32 devices)*/
	...
	#define LL_ADC_CHANNEL_10                                                                     \
		(ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN10 */
	#define LL_ADC_CHANNEL_11                                                                     \
		(ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN11 */
	#define LL_ADC_CHANNEL_12                                                                     \
		(ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN12 */
	#define LL_ADC_CHANNEL_13                                                                     \
		(ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN13 */
	#define LL_ADC_CHANNEL_14                                                                     \
		(ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN14 */
	#define LL_ADC_CHANNEL_15                                                                     \
		(ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN15 */
	#define LL_ADC_CHANNEL_16                                                                     \
		(ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN16 */
	#define LL_ADC_CHANNEL_17                                                                     \
		(ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP) /*!< ADC external channel (channel connected \
														to GPIO pin) ADCx_IN17 */
	#define LL_ADC_CHANNEL_18                                                                     \
		(ADC_CHANNEL_18_NUMBER | ADC_CHANNEL_18_SMP) /*!< ADC external channel (channel connected \
	...
	#define LL_ADC_CHANNEL_VREFINT                                                                \
		(LL_ADC_CHANNEL_17 |                                                                      \
		 ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal     \
										voltage reference. On STM32F7, ADC channel available only \
										on ADC instance: ADC1. */
	...
	#define LL_ADC_REG_TRIG_EXT_RISINGFALLING                                                      \
		(ADC_CR2_EXTEN_1 | ADC_CR2_EXTEN_0) /*!< ADC group regular conversion trigger polarity set \
	...
	#define LL_ADC_REG_CONV_CONTINUOUS                                                        \
		(ADC_CR2_CONT) /*!< ADC conversions are performed in continuous mode: after the first \
						  trigger, following conversions launched successively automatically */
	/**
	 * @}
	 */

	/** @defgroup ADC_LL_EC_REG_DMA_TRANSFER  ADC group regular - DMA transfer of ADC conversion
	 * data
	 * @{
	 */
	...
	#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                                      \
		(ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in limited mode (one shot \
						 mode): DMA transfer requests are stopped when number of DMA data        \
	...
	/** @defgroup ADC_LL_EC_REG_FLAG_EOC_SELECTION ADC group regular - Flag EOC selection (unitary
	...
	#define LL_ADC_REG_SEQ_SCAN_DISABLE                                                          \
		0x00000000U /*!< ADC group regular sequencer disable (equivalent to sequencer of 1 rank: \
	...
	#define LL_ADC_REG_SEQ_DISCONT_2RANKS                                                          \
		(ADC_CR1_DISCNUM_0 |                                                                       \
		 ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enabled with sequence \
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                                          \
		(ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external   \
										   IP: TIM1 TRGO. Trigger edge set to rising edge (default \
										   setting). */
	#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                                          \
		(ADC_CR2_JEXTSEL_0 |                                                                      \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external  \
										   IP: TIM1 channel 4 event (capture compare: input       \
										   capture or output capture). Trigger edge set to rising \
										   edge (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                          \
		(ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |                                                  \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external  \
										   IP: TIM2 channel 1 event (capture compare: input       \
										   capture or output capture). Trigger edge set to rising \
										   edge (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                          \
		(ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |                              \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external  \
										   IP: TIM8 channel 4 event (capture compare: input       \
										   capture or output capture). Trigger edge set to rising \
										   edge (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3                                                          \
		(ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |                              \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external  \
										   IP: TIM3 channel 3 event (capture compare: input       \
										   capture or output capture). Trigger edge set to rising \
										   edge (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1                                                          \
		(ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_0 |                              \
		 ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from external  \
										   IP: TIM3 channel 1 event (capture compare: input       \
										   capture or output capture). Trigger edge set to rising \
										   edge (default setting). */
	...
	#define LL_ADC_INJ_TRIG_EXT_RISINGFALLING                                                     \
		(ADC_CR2_JEXTEN_1 | ADC_CR2_JEXTEN_0) /*!< ADC group injected conversion trigger polarity \
	...
	#define LL_ADC_INJ_TRIG_INDEPENDENT                                                          \
		0x00000000U /*!< ADC group injected conversion trigger independent. Setting mandatory if \
					   ADC group injected injected trigger source is set to an external trigger. \
					 */
	#define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                                       \
		(ADC_CR1_JAUTO) /*!< ADC group injected conversion trigger from ADC group regular. Setting \
						   compliant only with group injected trigger source set to SW start,      \
						   without any further action on  ADC group injected conversion start or   \
						   stop: in this case, ADC group injected is controlled only from ADC      \
						   group regular. */
	/**
	 * @}
	 */
	...
	#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                           \
		0x00000000U /*!< ADC group injected sequencer disable (equivalent to sequencer of 1 rank: \
					   ADC conversion on only 1 channel) */
	...
	#define LL_ADC_INJ_SEQ_DISCONT_1RANK                                                   \
		(ADC_CR1_JDISCEN) /*!< ADC group injected sequencer discontinuous mode enable with \
	...
	#define LL_ADC_INJ_RANK_1                       \
		(ADC_JDR1_REGOFFSET | ADC_JOFR1_REGOFFSET | \
		 0x00000001U) /*!< ADC group injected sequencer rank 1 */
	#define LL_ADC_INJ_RANK_2                       \
		(ADC_JDR2_REGOFFSET | ADC_JOFR2_REGOFFSET | \
		 0x00000002U) /*!< ADC group injected sequencer rank 2 */
	#define LL_ADC_INJ_RANK_3                       \
		(ADC_JDR3_REGOFFSET | ADC_JOFR3_REGOFFSET | \
		 0x00000003U) /*!< ADC group injected sequencer rank 3 */
	#define LL_ADC_INJ_RANK_4                       \
		(ADC_JDR4_REGOFFSET | ADC_JOFR4_REGOFFSET | \
		 0x00000004U) /*!< ADC group injected sequencer rank 4 */
	/**
	 * @}
	 */
	...
	#define LL_ADC_AWD_CH_VREFINT_REG_INJ                                                          \
		((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |         \
		 ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to  \
							VrefInt: Internal voltage reference, converted by either group regular \
							or injected */
	#define LL_ADC_AWD_CH_VBAT_REG                                                                \
		((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                            \
		 ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to \
							Vbat/3: Vbat voltage through a divider ladder of factor 1/3 to have   \
							Vbat always below Vdda, converted by group regular only */
	#define LL_ADC_AWD_CH_VBAT_INJ                                                                \
		((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                           \
		 ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to \
							Vbat/3: Vbat voltage through a divider ladder of factor 1/3 to have   \
							Vbat always below Vdda, converted by group injected only */
	...
	#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                          \
		((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                      \
		 ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to \
							Temperature sensor, converted by group regular only. This internal    \
							channel is shared between temperature sensor and Vbat, only 1         \
	...
	#define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                                      \
		((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |     \
		 ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to \
							...
							This internal channel is shared between temperature sensor and Vbat,  \
	...
	#define LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM                                                  \
		...
		#define LL_ADC_MULTI_TRIPLE_REG_SIM_INJ_SIM                                               \
			(ADC_CCR_MULTI_4 |                                                                    \
			 ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: Combined group regular simultaneous + \
								 group injected simultaneous */
		#define LL_ADC_MULTI_TRIPLE_REG_SIM_INJ_ALT                                               \
			(ADC_CCR_MULTI_4 |                                                                    \
			 ADC_CCR_MULTI_1) /*!< ADC triple mode enabled: Combined group regular simultaneous + \
		...
		#define LL_ADC_MULTI_TRIPLE_INJ_ALTERN                                                \
			(ADC_CCR_MULTI_4 |                                                                \
			 ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: group injected alternate trigger. \
	...
	#define LL_ADC_MULTI_REG_DMA_EACH_ADC                                                         \
		0x00000000U /*!< ADC multimode group regular conversions are transferred by DMA: each ADC \
					   uses its own DMA channel, with its individual DMA transfer settings */
	#define LL_ADC_MULTI_REG_DMA_LIMIT_1                                                           \
		(ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred by DMA, one   \
						   DMA channel for all ADC instances (DMA of ADC master), in limited mode  \
						   (one shot mode): DMA transfer requests are stopped when number of DMA   \
						   data transfers (number of ADC conversions) is reached. This ADC mode is \
						   intended to be used with DMA mode non-circular. Setting of DMA mode 1:  \
						   2 or 3 (dual or triple mode) half-words one by one, ADC1 then ADC2 then \
						   ADC3. */
	#define LL_ADC_MULTI_REG_DMA_LIMIT_2                                                           \
		(ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are transferred by DMA, one   \
						   DMA channel for all ADC instances (DMA of ADC master), in limited mode  \
						   (one shot mode): DMA transfer requests are stopped when number of DMA   \
						   data transfers (number of ADC conversions) is reached. This ADC mode is \
						   intended to be used with DMA mode non-circular. Setting of DMA mode 2:  \
						   2 or 3 (dual or triple mode) half-words one by one, ADC2&1 then ADC1&3  \
						   then ADC3&2. */
	#define LL_ADC_MULTI_REG_DMA_LIMIT_3                                                           \
		(ADC_CCR_DMA_0 |                                                                           \
		 ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred by DMA, one   \
						   ...
						   (one shot mode): DMA transfer requests are stopped when number of DMA   \
						   data transfers (number of ADC conversions) is reached. This ADC mode is \
						   intended to be used with DMA mode non-circular. Setting of DMA mode 3:  \
						   2 or 3 (dual or triple mode) bytes one by one, ADC2&1 then ADC1&3 then  \
						   ADC3&2. */
	#define LL_ADC_MULTI_REG_DMA_UNLMT_1                                                           \
		(ADC_CCR_DDS |                                                                             \
		 ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred by DMA, one   \
						   DMA channel for all ADC instances (DMA of ADC master), in unlimited     \
						   mode: DMA transfer requests are unlimited, whatever number of DMA data  \
						   transferred (number of ADC conversions) is reached. This ADC mode is    \
						   intended to be used with DMA mode non-circular. Setting of DMA mode 1:  \
						   2 or 3 (dual or triple mode) half-words one by one, ADC1 then ADC2 then \
						   ADC3. */
	#define LL_ADC_MULTI_REG_DMA_UNLMT_2                                                          \
		(ADC_CCR_DDS |                                                                            \
		 ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are transferred by DMA, one  \
						   ...
						   transferred (number of ADC conversions) is reached. This ADC mode is   \
						   intended to be used with DMA mode non-circular. Setting of DMA mode 2: \
						   2 or 3 (dual or triple mode) half-words by pairs, ADC2&1 then ADC1&3   \
						   then ADC3&2. */
	...
	#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES                                                     \
		(ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: \
											   8 ADC clock cycles */
	...
	#define LL_ADC_MULTI_TWOSMP_DELAY_10CYCLES                                                    \
		(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: \
											   10 ADC clock cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_11CYCLES                                                    \
		(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: \
											   11 ADC clock cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_12CYCLES                                               \
		(ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                                 \
		 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 12 ADC clock \
							 cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_13CYCLES                                               \
		(ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling phases: 13 ADC clock \
							 cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES                                                    \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: \
											   14 ADC clock cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_15CYCLES                                                    \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: \
											   15 ADC clock cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_16CYCLES                                               \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1 |                                                 \
		 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 16 ADC clock \
							 cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_17CYCLES                                                    \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling phases: \
											   17 ADC clock cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_18CYCLES                                               \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 |                                                 \
		 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 18 ADC clock \
							 cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_19CYCLES                                               \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 |                                                 \
		 ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 19 ADC clock \
							 cycles */
	#define LL_ADC_MULTI_TWOSMP_DELAY_20CYCLES                                               \
		(ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                               \
		 ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 20 ADC clock \
							 cycles */
	/**
	 * @}
	 */
	 ...
	 * this internal channel is shared between temperature sensor and Vbat, only 1 measurement path
	 * must be enabled.
	 ...
	 *         (1) On STM32F7, parameter available only on ADC instance: ADC1.\n
	 *         (2) On devices STM32F75x, STM32F74x, STM32F76x, STM32F77x, STM32F72x and STM32F73x
	 * limitation: this internal channel is shared between temperature sensor and Vbat, only 1
	 ...
	 *
	 *         (1) On STM32F7, parameter available only on ADC instance: ADC1.
	 *         (2) On devices STM32F7x, limitation: this internal channel is shared between
	...
	#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__) \
		(((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_VBAT))
	/**
	 ...
	 *
	 *         (1) On STM32F7, parameter available only on ADC instance: ADC1.\n
	 *         (2) On devices STM32F7xx,a limitation: this internal channel is shared between
	 * temperature sensor and Vbat, only 1 measurement path must be enabled.
	 */
	 ...
	 * value (unit uV/DegCelsius). On STM32F7, refer to device datasheet parameter "Avg_Slope".
	 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data Temperature sensor voltage
	 * typical value (at temperature and Vref+ defined in parameters below) (unit mV). On STM32F4,
	...
	/** @defgroup ADC_LL_EF_Configuration_ADC_Common Configuration of ADC hierarchical scope: common
	 * to several ADC instances
	 * @{
	 */
	...
	__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerRanks(ADC_TypeDef* ADCx, uint32_t Rank)
	{
		...
		return (uint32_t)(READ_BIT(*preg, ADC_CHANNEL_ID_NUMBER_MASK
	...
	/** @defgroup ADC_LL_EF_Configuration_ADC_Group_Injected Configuration of ADC hierarchical
	 * scope: group injected
	 * @{
	 */
	...
	__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDMonitChannels(ADC_TypeDef* ADCx)
	{
		return (uint32_t)(READ_BIT(
			ADCx->CR1, (ADC_CR1_AWDEN | ADC_CR1_JAWDEN | ADC_CR1_AWDSGL | ADC_CR1_AWDCH)));
	}
