...
#define FMC_SDRAM_DEVICE FMC_Bank5_6
	...
	typedef struct
	{
		...
		uint32_t
			MemoryDataWidth; /*!< Specifies the external memory device width.
		...
		uint32_t
			WriteOperation; /*!< Enables or disables the write operation in the selected device by
							   the FMC. This parameter can be a value of @ref FMC_Write_Operation */
		...
		uint32_t
			AsynchronousWait; /*!< Enables or disables wait signal during asynchronous transfers,
	...
	typedef struct
	{
		...
		uint32_t
			RowBitsNumber; /*!< Defines the number of bits of column address.
		...
		uint32_t
			SDClockPeriod; /*!< Define the SDRAM Clock Period for both SDRAM devices and they allow
		...
		uint32_t
			ReadPipeDelay; /*!< Define the delay in system clock cycles on read data path.
	...
	typedef struct
	{
		...
		uint32_t
			RPDelay; /*!< Defines the delay between a Precharge Command and an other command
						  in number of memory clock cycles.
						  This parameter can be a value between Min_Data = 1 and Max_Data = 16  */

		uint32_t
			RCDDelay; /*!< Defines the delay between the Activate Command and a Read/Write
	...
	typedef struct
	{
		...
		uint32_t
			CommandTarget; /*!< Defines which device (1 or 2) the command will be issued to.
...
#define __FMC_SDRAM_CLEAR_FLAG(__INSTANCE__, __FLAG__) ((__INSTANCE__)->SDRTR |= (__FLAG__))
	 ...
	 *  @{
	 */
	/** @defgroup FMC_LL_NAND_Private_Functions_Group1 NAND Initialization/de-initialization
	 * functions
	 *  @{
	 */
	 ...
	 *  @{
	 */
	/** @defgroup FMC_LL_SDRAM_Private_Functions_Group1 SDRAM Initialization/de-initialization
	 * functions
	 *  @{
	 */
