...
#include "stm32f7xx_hal_def.h"
	...
	#define ETH_MAC_ADDR_HBASE \
		(uint32_t)(ETH_MAC_BASE + (uint32_t)0x40U) /* Ethernet MAC address high offset */
	#define ETH_MAC_ADDR_LBASE \
		(uint32_t)(ETH_MAC_BASE + (uint32_t)0x44U) /* Ethernet MAC address low offset */
	...
	typedef struct
	{
		uint32_t AutoNegotiation; /*!< Selects or not the AutoNegotiation mode for the external PHY
										   The AutoNegotiation allows an automatic setting of the
									 Speed (10/100Mbps) and the mode (half/full-duplex). This
		...
		uint32_t MediaInterface; /*!< Selects the media-independent interface or the reduced
								 media-independent interface. This parameter can be a value of @ref
								 ETH_Media_Interface */
	...
	{
		uint32_t
			Watchdog; /*!< Selects or not the Watchdog timer
		...
		uint32_t
			InterFrameGap; /*!< Selects the minimum IFG between frames during transmission.
		...
		uint32_t ReceiveOwn; /*!< Selects or not the ReceiveOwn,
									  ReceiveOwn allows the reception of frames when the TX_EN
								signal is asserted in Half-Duplex mode. This parameter can be a
								value of @ref ETH_Receive_Own */

		uint32_t LoopbackMode; /*!< Selects or not the internal MAC MII Loopback mode.
										This parameter can be a value of @ref ETH_Loop_Back_Mode */

		uint32_t ChecksumOffload; /*!< Selects or not the IPv4 checksum checking for received frame
									 payloads' TCP/UDP/ICMP headers. This parameter can be a value
									 of @ref ETH_Checksum_Offload */

		uint32_t RetryTransmission; /*!< Selects or not the MAC attempt retries transmission, based
									   on the settings of BL, when a collision occurs (Half-Duplex
		...
		uint32_t PassControlFrames; /*!< Sets the forwarding mode of the control frames (including
									   unicast and multicast PAUSE frames) This parameter can be a
									   value of @ref ETH_Pass_Control_Frames */

		uint32_t BroadcastFramesReception; /*!< Selects or not the reception of Broadcast Frames.
													This parameter can be a value of @ref
											  ETH_Broadcast_Frames_Reception */

		uint32_t DestinationAddrFilter; /*!< Sets the destination filter mode for both unicast and
										   multicast frames. This parameter can be a value of @ref
										   ETH_Destination_Addr_Filter */

		uint32_t
			PromiscuousMode; /*!< Selects or not the Promiscuous Mode
		...
		uint32_t
			UnicastFramesFilter; /*!< Selects the Unicast Frames filter mode:
									HashTableFilter/PerfectFilter/PerfectHashTableFilter. This
									parameter can be a value of @ref ETH_Unicast_Frames_Filter */
		...
		uint32_t PauseTime; /*!< This field holds the value to be used in the Pause Time field in
							   the transmit control frame. This parameter must be a number between
							   Min_Data = 0x0 and Max_Data = 0xFFFF */

		uint32_t ZeroQuantaPause; /*!< Selects or not the automatic generation of Zero-Quanta Pause
									 Control frames. This parameter can be a value of @ref
									 ETH_Zero_Quanta_Pause */

		uint32_t PauseLowThreshold; /*!< This field configures the threshold of the PAUSE to be
									   checked for automatic retransmission of PAUSE Frame. This
									   parameter can be a value of @ref ETH_Pause_Low_Threshold */

		uint32_t UnicastPauseFrameDetect; /*!< Selects or not the MAC detection of the Pause frames
											 (with MAC Address0 unicast address and unique multicast
											 address). This parameter can be a value of @ref
											 ETH_Unicast_Pause_Frame_Detect */

		uint32_t ReceiveFlowControl; /*!< Enables or disables the MAC to decode the received Pause
										frame and disable its transmitter for a specified time
										(Pause Time) This parameter can be a value of @ref
										ETH_Receive_Flow_Control */

		uint32_t TransmitFlowControl; /*!< Enables or disables the MAC to transmit Pause frames
										 (Full-Duplex mode) or the MAC back-pressure operation
										 (Half-Duplex mode) This parameter can be a value of @ref
										 ETH_Transmit_Flow_Control */

		uint32_t VLANTagComparison; /*!< Selects the 12-bit VLAN identifier or the complete 16-bit
									   VLAN tag for comparison and filtering. This parameter can be
									   a value of @ref ETH_VLAN_Tag_Comparison */
	...
	typedef struct
	{
		uint32_t DropTCPIPChecksumErrorFrame; /*!< Selects or not the Dropping of TCP/IP Checksum
												 Error Frames. This parameter can be a value of @ref
		...
		uint32_t
			ForwardUndersizedGoodFrames; /*!< Enables or disables the Rx FIFO to forward Undersized
											frames (frames with no Error and length less than 64
											bytes) including pad-bytes and CRC) This parameter can
											be a value of @ref ETH_Forward_Undersized_Good_Frames */

		uint32_t ReceiveThresholdControl; /*!< Selects the threshold level of the Receive FIFO.
												   This parameter can be a value of @ref
											 ETH_Receive_Threshold_Control */

		uint32_t SecondFrameOperate; /*!< Selects or not the Operate on second frame mode, which
										allows the DMA to process a second frame of Transmit data
										even before obtaining the status for the first frame. This
										parameter can be a value of @ref ETH_Second_Frame_Operate */

		uint32_t AddressAlignedBeats; /*!< Enables or disables the Address Aligned Beats.
											   This parameter can be a value of @ref
										 ETH_Address_Aligned_Beats */

		uint32_t FixedBurst; /*!< Enables or disables the AHB Master interface fixed burst
								transfers. This parameter can be a value of @ref ETH_Fixed_Burst */
		...
		uint32_t DescriptorSkipLength; /*!< Specifies the number of word to skip between two
										  unchained descriptors (Ring mode) This parameter must be a
										  number between Min_Data = 0 and Max_Data = 32 */

		uint32_t
			DMAArbitration; /*!< Selects the DMA Tx/Rx arbitration.
	...
	#define ETH_MAX_PACKET_SIZE                                                              \
		((uint32_t)1524U) /*!< ETH_HEADER + ETH_EXTRA + ETH_VLAN_TAG + ETH_MAX_ETH_PAYLOAD + \
							 ETH_CRC */
	#define ETH_HEADER                                                             \
		((uint32_t)14U) /*!< 6 byte Dest addr, 6 byte Src addr, 2 byte length/type \
						 */
	...
	*/
	...
	#define ETH_DMATXDESC_OWN \
		((uint32_t)0x80000000U) /*!< OWN bit: descriptor is owned by DMA engine */
	...
	#define ETH_DMATXDESC_CIC_BYPASS \
		((uint32_t)0x00000000U) /*!< Do Nothing: Checksum Engine is bypassed */
	#define ETH_DMATXDESC_CIC_IPV4HEADER \
		((uint32_t)0x00400000U) /*!< IPV4 header Checksum Insertion */
	#define ETH_DMATXDESC_CIC_TCPUDPICMP_SEGMENT                                                  \
		((uint32_t)0x00800000U) /*!< TCP/UDP/ICMP Checksum Insertion calculated over segment only \
								 */
	#define ETH_DMATXDESC_CIC_TCPUDPICMP_FULL \
		((uint32_t)0x00C00000U) /*!< TCP/UDP/ICMP Checksum Insertion fully calculated */
	...
	#define ETH_DMATXDESC_ES                                                                    \
		((uint32_t)0x00008000U) /*!< Error summary: OR of the following bits: UE || ED || EC || \
								   LCO || NC || LCA || FF || JT */
	#define ETH_DMATXDESC_JT ((uint32_t)0x00004000U) /*!< Jabber Timeout */
	#define ETH_DMATXDESC_FF \
		((uint32_t)0x00002000U) /*!< Frame Flushed: DMA/MTL flushed the frame due to SW flush */
	#define ETH_DMATXDESC_PCE ((uint32_t)0x00001000U) /*!< Payload Checksum Error */
	#define ETH_DMATXDESC_LCA \
		((uint32_t)0x00000800U) /*!< Loss of Carrier: carrier lost during transmission */
	#define ETH_DMATXDESC_NC \
		((uint32_t)0x00000400U) /*!< No Carrier: no carrier signal from the transceiver */
	#define ETH_DMATXDESC_LCO \
		((uint32_t)0x00000200U) /*!< Late Collision: transmission aborted due to collision */
	#define ETH_DMATXDESC_EC                                                                       \
		((uint32_t)0x00000100U) /*!< Excessive Collision: transmission aborted after 16 collisions \
								 */
	...
	#define ETH_DMATXDESC_UF \
		((uint32_t)0x00000002U) /*!< Underflow Error: late data arrival from the memory */
	...
	/*
	  ...
	  ---------------------------------------------------------------------------------------------------------------------
	  RDES1 | CTRL(31) | Reserved[30:29] | Buffer2 ByteCount[28:16] | CTRL[15:14] | Reserved(13) |
	  Buffer1 ByteCount[12:0] |
	  ---------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	#define ETH_DMARXDESC_ES                                                                     \
		((uint32_t)0x00008000U) /*!< Error summary: OR of the following bits: DE || OE || IPC || \
								   LC || RWT || RE || CE */
	#define ETH_DMARXDESC_DE \
		((uint32_t)0x00004000U) /*!< Descriptor error: no more descriptors for receive frame  */
	#define ETH_DMARXDESC_SAF                                              \
		((uint32_t)0x00002000U) /*!< SA Filter Fail for the received frame \
								 */
	#define ETH_DMARXDESC_LE \
		((uint32_t)0x00001000U) /*!< Frame size not matching with length field */
	#define ETH_DMARXDESC_OE \
		((uint32_t)0x00000800U) /*!< Overflow Error: Frame was damaged due to buffer overflow */
	#define ETH_DMARXDESC_VLAN \
		((uint32_t)0x00000400U) /*!< VLAN Tag: received frame is a VLAN frame */
	...
	#define ETH_DMARXDESC_IPV4HCE \
		((uint32_t)0x00000080U) /*!< IPC Checksum Error: Rx Ipv4 header checksum error   */
	#define ETH_DMARXDESC_LC \
		((uint32_t)0x00000040U) /*!< Late collision occurred during reception   */
	#define ETH_DMARXDESC_FT \
		((uint32_t)0x00000020U) /*!< Frame type - Ethernet, otherwise 802.3    */
	#define ETH_DMARXDESC_RWT                                                                \
		((uint32_t)0x00000010U) /*!< Receive Watchdog Timeout: watchdog timer expired during \
								   reception    */
	#define ETH_DMARXDESC_RE \
		((uint32_t)0x00000008U) /*!< Receive error: error reported by MII interface  */
	#define ETH_DMARXDESC_DBE                                                                     \
		((uint32_t)0x00000004U) /*!< Dribble bit error: frame contains non int multiple of 8 bits \
								 */
	#define ETH_DMARXDESC_CE ((uint32_t)0x00000002U) /*!< CRC error */
	#define ETH_DMARXDESC_MAMPCE                                                           \
		((uint32_t)0x00000001U) /*!< Rx MAC Address/Payload Checksum Error: Rx MAC address \
								   matched/ Rx Payload Checksum Error */
	...
	#define ETH_DMAPTPRXDESC_PTPMT_SYNC                           \
		((uint32_t)0x00000100U) /* SYNC message (all clock types) \
								 */
	#define ETH_DMAPTPRXDESC_PTPMT_FOLLOWUP \
		((uint32_t)0x00000200U) /* FollowUp message (all clock types) */
	#define ETH_DMAPTPRXDESC_PTPMT_DELAYREQ \
		((uint32_t)0x00000300U) /* DelayReq message (all clock types) */
	#define ETH_DMAPTPRXDESC_PTPMT_DELAYRESP \
		((uint32_t)0x00000400U) /* DelayResp message (all clock types) */
	#define ETH_DMAPTPRXDESC_PTPMT_PDELAYREQ_ANNOUNCE                                             \
		((uint32_t)0x00000500U) /* PdelayReq message (peer-to-peer transparent clock) or Announce \
								   message (Ordinary or Boundary clock) */
	#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESP_MANAG                                       \
		((uint32_t)0x00000600U) /* PdelayResp message (peer-to-peer transparent clock) or \
								   Management message (Ordinary or Boundary clock)  */
	#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESPFOLLOWUP_SIGNAL                                      \
		((uint32_t)0x00000700U) /* PdelayRespFollowUp message (peer-to-peer transparent clock) or \
								   Signaling message (Ordinary or Boundary clock) */
	...
	#define ETH_DMAPTPRXDESC_IPPT_UDP \
		((uint32_t)0x00000001U) /* UDP payload encapsulated in the IP datagram */
	#define ETH_DMAPTPRXDESC_IPPT_TCP \
		((uint32_t)0x00000002U) /* TCP payload encapsulated in the IP datagram */
	#define ETH_DMAPTPRXDESC_IPPT_ICMP \
		((uint32_t)0x00000003U) /* ICMP payload encapsulated in the IP datagram */
	...
	#define ETH_INTERFRAMEGAP_96BIT \
		((uint32_t)0x00000000U) /*!< minimum IFG between frames during transmission is 96Bit */
	#define ETH_INTERFRAMEGAP_88BIT \
		((uint32_t)0x00020000U) /*!< minimum IFG between frames during transmission is 88Bit */
	#define ETH_INTERFRAMEGAP_80BIT \
		((uint32_t)0x00040000U) /*!< minimum IFG between frames during transmission is 80Bit */
	#define ETH_INTERFRAMEGAP_72BIT \
		((uint32_t)0x00060000U) /*!< minimum IFG between frames during transmission is 72Bit */
	#define ETH_INTERFRAMEGAP_64BIT \
		((uint32_t)0x00080000U) /*!< minimum IFG between frames during transmission is 64Bit */
	#define ETH_INTERFRAMEGAP_56BIT \
		((uint32_t)0x000A0000U) /*!< minimum IFG between frames during transmission is 56Bit */
	#define ETH_INTERFRAMEGAP_48BIT \
		((uint32_t)0x000C0000U) /*!< minimum IFG between frames during transmission is 48Bit */
	#define ETH_INTERFRAMEGAP_40BIT \
		((uint32_t)0x000E0000U) /*!< minimum IFG between frames during transmission is 40Bit */
	/**
	 * @}
	 */
	...
	#define ETH_PASSCONTROLFRAMES_BLOCKALL                                                        \
		((uint32_t)0x00000040U) /*!< MAC filters all control frames from reaching the application \
								 */
	#define ETH_PASSCONTROLFRAMES_FORWARDALL                                                     \
		((uint32_t)0x00000080U) /*!< MAC forwards all control frames to application even if they \
								   fail the Address Filter */
	#define ETH_PASSCONTROLFRAMES_FORWARDPASSEDADDRFILTER \
		((uint32_t)0x000000C0U) /*!< MAC forwards control frames that pass the Address Filter. */
	/**
	 * @}
	 */
	...
	#define ETH_PAUSELOWTHRESHOLD_MINUS4 \
		((uint32_t)0x00000000U) /*!< Pause time minus 4 slot times */
	#define ETH_PAUSELOWTHRESHOLD_MINUS28 \
		((uint32_t)0x00000010U) /*!< Pause time minus 28 slot times */
	#define ETH_PAUSELOWTHRESHOLD_MINUS144 \
		((uint32_t)0x00000020U) /*!< Pause time minus 144 slot times */
	#define ETH_PAUSELOWTHRESHOLD_MINUS256 \
		((uint32_t)0x00000030U) /*!< Pause time minus 256 slot times */
	/**
	 * @}
	 */
	...
	#define ETH_MAC_ADDRESSMASK_BYTE6 \
		((uint32_t)0x20000000U) /*!< Mask MAC Address high reg bits [15:8] */
	#define ETH_MAC_ADDRESSMASK_BYTE5 \
		((uint32_t)0x10000000U) /*!< Mask MAC Address high reg bits [7:0] */
	#define ETH_MAC_ADDRESSMASK_BYTE4 \
		((uint32_t)0x08000000U) /*!< Mask MAC Address low reg bits [31:24] */
	#define ETH_MAC_ADDRESSMASK_BYTE3 \
		((uint32_t)0x04000000U) /*!< Mask MAC Address low reg bits [23:16] */
	#define ETH_MAC_ADDRESSMASK_BYTE2 \
		((uint32_t)0x02000000U) /*!< Mask MAC Address low reg bits [15:8] */
	#define ETH_MAC_ADDRESSMASK_BYTE1 \
		((uint32_t)0x01000000U) /*!< Mask MAC Address low reg bits [70] */
	/**
	 * @}
	 */
	...
	#define ETH_TRANSMITTHRESHOLDCONTROL_64BYTES \
		((uint32_t)0x00000000U) /*!< threshold level of the MTL Transmit FIFO is 64 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_128BYTES \
		((uint32_t)0x00004000U) /*!< threshold level of the MTL Transmit FIFO is 128 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_192BYTES \
		((uint32_t)0x00008000U) /*!< threshold level of the MTL Transmit FIFO is 192 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_256BYTES \
		((uint32_t)0x0000C000U) /*!< threshold level of the MTL Transmit FIFO is 256 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_40BYTES \
		((uint32_t)0x00010000U) /*!< threshold level of the MTL Transmit FIFO is 40 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_32BYTES \
		((uint32_t)0x00014000U) /*!< threshold level of the MTL Transmit FIFO is 32 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_24BYTES \
		((uint32_t)0x00018000U) /*!< threshold level of the MTL Transmit FIFO is 24 Bytes */
	#define ETH_TRANSMITTHRESHOLDCONTROL_16BYTES \
		((uint32_t)0x0001C000U) /*!< threshold level of the MTL Transmit FIFO is 16 Bytes */
	/**
	 * @}
	 */
	...
	#define ETH_RECEIVEDTHRESHOLDCONTROL_64BYTES \
		((uint32_t)0x00000000U) /*!< threshold level of the MTL Receive FIFO is 64 Bytes */
	#define ETH_RECEIVEDTHRESHOLDCONTROL_32BYTES \
		((uint32_t)0x00000008U) /*!< threshold level of the MTL Receive FIFO is 32 Bytes */
	#define ETH_RECEIVEDTHRESHOLDCONTROL_96BYTES \
		((uint32_t)0x00000010U) /*!< threshold level of the MTL Receive FIFO is 96 Bytes */
	#define ETH_RECEIVEDTHRESHOLDCONTROL_128BYTES \
		((uint32_t)0x00000018U) /*!< threshold level of the MTL Receive FIFO is 128 Bytes */
	/**
	 * @}
	 */
	...
	#define ETH_RXDMABURSTLENGTH_1BEAT                                                      \
		((uint32_t)0x00020000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 1 */
	#define ETH_RXDMABURSTLENGTH_2BEAT                                                      \
		((uint32_t)0x00040000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 2 */
	#define ETH_RXDMABURSTLENGTH_4BEAT                                                      \
		((uint32_t)0x00080000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 4 */
	#define ETH_RXDMABURSTLENGTH_8BEAT                                                      \
		((uint32_t)0x00100000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 8 */
	#define ETH_RXDMABURSTLENGTH_16BEAT                                                     \
		((uint32_t)0x00200000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 16 */
	#define ETH_RXDMABURSTLENGTH_32BEAT                                                     \
		((uint32_t)0x00400000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 32 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_4BEAT                                                \
		((uint32_t)0x01020000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 4 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_8BEAT                                                \
		((uint32_t)0x01040000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 8 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_16BEAT                                               \
		((uint32_t)0x01080000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 16 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_32BEAT                                               \
		((uint32_t)0x01100000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 32 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_64BEAT                                               \
		((uint32_t)0x01200000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 64 */
	#define ETH_RXDMABURSTLENGTH_4XPBL_128BEAT                                              \
		((uint32_t)0x01400000U) /*!< maximum number of beats to be transferred in one RxDMA \
								   transaction is 128 */
	/**
	 * @}
	 */
	...
	#define ETH_TXDMABURSTLENGTH_1BEAT                                                          \
		((uint32_t)0x00000100U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 1 */
	#define ETH_TXDMABURSTLENGTH_2BEAT                                                          \
		((uint32_t)0x00000200U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 2 */
	#define ETH_TXDMABURSTLENGTH_4BEAT                                                          \
		((uint32_t)0x00000400U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 4 */
	#define ETH_TXDMABURSTLENGTH_8BEAT                                                          \
		((uint32_t)0x00000800U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 8 */
	#define ETH_TXDMABURSTLENGTH_16BEAT                                                         \
		((uint32_t)0x00001000U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 16 */
	#define ETH_TXDMABURSTLENGTH_32BEAT                                                         \
		((uint32_t)0x00002000U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 32 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_4BEAT                                                    \
		((uint32_t)0x01000100U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 4 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_8BEAT                                                    \
		((uint32_t)0x01000200U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 8 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_16BEAT                                                   \
		((uint32_t)0x01000400U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 16 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_32BEAT                                                   \
		((uint32_t)0x01000800U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 32 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_64BEAT                                                   \
		((uint32_t)0x01001000U) /*!< maximum number of beats to be transferred in one TxDMA (or \
								   both) transaction is 64 */
	#define ETH_TXDMABURSTLENGTH_4XPBL_128BEAT                                                  \
		((uint32_t)0x01002000U) /*!< maximum number of beats to be transferred in one TxDMA (or \
	...
	/** @defgroup ETH_DMA_Tx_descriptor_Checksum_Insertion_Control ETH DMA Tx descriptor Checksum
	 * Insertion Control
	 * @{
	 */
	...
	#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT                                             \
		((uint32_t)0x00800000U) /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is \
								   assumed to be present */
	#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL                                              \
		((uint32_t)0x00C00000U) /*!< TCP/UDP/ICMP checksum fully in hardware including pseudo \
								   header */
	/**
	 * @}
	 */
	...
	#define ETH_PMT_FLAG_WUFFRPR \
		((uint32_t)0x80000000U) /*!< Wake-Up Frame Filter Register Pointer Reset */
	...
	#define ETH_MMC_IT_TGF \
		((uint32_t)0x00200000U) /*!< When Tx good frame counter reaches half the maximum value */
	#define ETH_MMC_IT_TGFMSC                                                                      \
		((uint32_t)0x00008000U) /*!< When Tx good multi col counter reaches half the maximum value \
								 */
	#define ETH_MMC_IT_TGFSC                                                                  \
		((uint32_t)0x00004000U) /*!< When Tx good single col counter reaches half the maximum \
								   value */
	/**
	 * @}
	 */
	...
	#define ETH_MMC_IT_RGUF                                                                       \
		((uint32_t)0x10020000U) /*!< When Rx good unicast frames counter reaches half the maximum \
								   value */
	#define ETH_MMC_IT_RFAE                                                                   \
		((uint32_t)0x10000040U) /*!< When Rx alignment error counter reaches half the maximum \
								   value */
	#define ETH_MMC_IT_RFCE \
		((uint32_t)0x10000020U) /*!< When Rx crc error counter reaches half the maximum value */
	/**
	 * @}
	 */
	...
	#define ETH_DMA_FLAG_DATATRANSFERERROR \
		((uint32_t)0x00800000U) /*!< Error bits 0-Rx DMA, 1-Tx DMA */
	#define ETH_DMA_FLAG_READWRITEERROR \
		((uint32_t)0x01000000U) /*!< Error bits 0-write transfer, 1-read transfer */
	#define ETH_DMA_FLAG_ACCESSERROR \
		((uint32_t)0x02000000U) /*!< Error bits 0-data buffer, 1-desc. access */
	...
	#define ETH_DMA_TRANSMITPROCESS_STOPPED \
		((uint32_t)0x00000000U) /*!< Stopped - Reset or Stop Tx Command issued */
	#define ETH_DMA_TRANSMITPROCESS_FETCHING \
		((uint32_t)0x00100000U) /*!< Running - fetching the Tx descriptor */
	#define ETH_DMA_TRANSMITPROCESS_WAITING \
		((uint32_t)0x00200000U) /*!< Running - waiting for status */
	#define ETH_DMA_TRANSMITPROCESS_READING \
		((uint32_t)0x00300000U) /*!< Running - reading the data from host memory */
	#define ETH_DMA_TRANSMITPROCESS_SUSPENDED \
		((uint32_t)0x00600000U) /*!< Suspended - Tx Descriptor unavailable */
	#define ETH_DMA_TRANSMITPROCESS_CLOSING \
		((uint32_t)0x00700000U) /*!< Running - closing Rx descriptor */
	...
	#define ETH_DMA_RECEIVEPROCESS_STOPPED \
		((uint32_t)0x00000000U) /*!< Stopped - Reset or Stop Rx Command issued */
	#define ETH_DMA_RECEIVEPROCESS_FETCHING \
		((uint32_t)0x00020000U) /*!< Running - fetching the Rx descriptor */
	#define ETH_DMA_RECEIVEPROCESS_WAITING \
		((uint32_t)0x00060000U) /*!< Running - waiting for packet */
	#define ETH_DMA_RECEIVEPROCESS_SUSPENDED \
		((uint32_t)0x00080000U) /*!< Suspended - Rx Descriptor unavailable */
	#define ETH_DMA_RECEIVEPROCESS_CLOSING \
		((uint32_t)0x000A0000U) /*!< Running - closing descriptor */
	#define ETH_DMA_RECEIVEPROCESS_QUEUING \
		((uint32_t)0x000E0000U) /*!< Running - queuing the receive frame into host memory */
	...
	#define ETH_DMA_OVERFLOW_RXFIFOCOUNTER \
		((uint32_t)0x10000000U) /*!< Overflow bit for FIFO overflow counter */
	#define ETH_DMA_OVERFLOW_MISSEDFRAMECOUNTER \
		((uint32_t)0x00010000U) /*!< Overflow bit for missed frame counter */
	/**
	 * @}
	 */
	...
	#define ETH_EXTI_LINE_WAKEUP \
		((uint32_t)0x00080000U) /*!< External interrupt line 19 Connected to the ETH EXTI Line */
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_DMARXDESC_SET_OWN_BIT(__HANDLE__) \
		((__HANDLE__)->RxDesc->Status |= ETH_DMARXDESC_OWN)
	...
	#define __HAL_ETH_DMATXDESC_SET_OWN_BIT(__HANDLE__) \
		((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_OWN)
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_DMATXDESC_ENABLE_IT(__HANDLE__) \
		((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_IC)
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_DMATXDESC_DISABLE_IT(__HANDLE__) \
		((__HANDLE__)->TxDesc->Status &= ~ETH_DMATXDESC_IC)
	 ...
	 *     @arg ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT : TCP/UDP/ICMP checksum. Pseudo header
	 * checksum is assumed to be present
	 *     @arg ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL : TCP/UDP/ICMP checksum fully in hardware
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_DMATXDESC_CRC_ENABLE(__HANDLE__) \
		((__HANDLE__)->TxDesc->Status &= ~ETH_DMATXDESC_DC)
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_DMATXDESC_CRC_DISABLE(__HANDLE__) \
		((__HANDLE__)->TxDesc->Status |= ETH_DMATXDESC_DC)
	 ...
	 *     @arg ETH_DMA_OVERFLOW_MISSEDFRAMECOUNTER : Overflow for Buffer Unavailable Missed Frame
	 * Counter
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_POWER_DOWN_ENABLE(__HANDLE__) \
	 ...
	 * @retval None
	 */
	#define __HAL_ETH_MMC_COUNTER_FREEZE_ENABLE(__HANDLE__) \
	 ...
	 *   This parameter can be one of the following values:
	 *     @arg ETH_MMC_IT_RGUF  : When Rx good unicast frames counter reaches half the maximum
	 * value
