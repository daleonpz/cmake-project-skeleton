...
#include "stm32f7xx_hal_def.h"
	...
	typedef struct
	{
		...
		uint32_t
			BS1; /*!< Specifies the number of time quanta in Bit Segment 1.
					  This parameter can be a value of @ref CAN_time_quantum_in_bit_segment_1 */

		uint32_t
			BS2; /*!< Specifies the number of time quanta in Bit Segment 2.
	...
	typedef struct
	{
		...
		uint32_t FilterFIFOAssignment; /*!< Specifies the FIFO (0 or 1) which will be assigned to
	...
	typedef struct
	{
		...
		uint32_t FMI; /*!< Specifies the index of the filter the message stored in the mailbox
						 passes through. This parameter must be a number between Min_Data = 0 and
						 Max_Data = 0xFF */
