...
#include <stdint.h>
	...
	{
		__IO uint32_t
			PCR; /*!< NAND Flash control register,                       Address offset: 0x80 */
		__IO uint32_t
			SR; /*!< NAND Flash FIFO status and interrupt register,     Address offset: 0x84 */
		__IO uint32_t
			PMEM; /*!< NAND Flash Common memory space timing register,    Address offset: 0x88 */
		__IO uint32_t
			PATT; /*!< NAND Flash Attribute memory space timing register, Address offset: 0x8C */
		uint32_t RESERVED0; /*!< Reserved, 0x90 */
		__IO uint32_t
			ECCR; /*!< NAND Flash ECC result registers,                   Address offset: 0x94 */
	} FMC_Bank3_TypeDef;
	...
	typedef struct
	{
		...
		__IO uint32_t DCKCFGR1; /*!< RCC Dedicated Clocks configuration register1, Address offset:
								   0x8C */
		__IO uint32_t DCKCFGR2; /*!< RCC Dedicated Clocks configuration register 2, Address offset:
								   0x90 */
	...
	typedef struct
	{
		...
		__IO uint32_t OR; /*!< RTC option register,                                       Address
							 offset: 0x4C */
	...
	{
		__IO uint32_t
			USB_HS_PHYC_PLL; /*!< This register is used to control the PLL of the HS PHY. 000h */
		__IO uint32_t Reserved04; /*!< Reserved 004h */
		__IO uint32_t Reserved08; /*!< Reserved 008h */
		__IO uint32_t USB_HS_PHYC_TUNE; /*!< This register is used to control the tuning interface
										   of the High Speed PHY.  00Ch */
		__IO uint32_t Reserved10; /*!< Reserved 010h */
		__IO uint32_t Reserved14; /*!< Reserved 014h */
		__IO uint32_t
			USB_HS_PHYC_LDO; /*!< This register is used to control the regulator (LDO). 018h */
 ...
 */
#define RAMITCM_BASE                                                                               \
	0x00000000UL /*!< Base address of : 16KB RAM reserved for CPU execution/instruction accessible \
					over ITCM  */
#define FLASHITCM_BASE                                                                             \
	0x00200000UL /*!< Base address of : (up to 512 KB) embedded FLASH memory  accessible over ITCM \
				  */
#define FLASHAXI_BASE                                                                            \
	0x08000000UL /*!< Base address of : (up to 512 KB) embedded FLASH memory accessible over AXI \
				  */
#define RAMDTCM_BASE \
	0x20000000UL /*!< Base address of : 64KB system data RAM accessible over DTCM */
...
#define FLASH_OTP_BASE \
	0x1FF07800UL /*!< Base address of : (up to 528 Bytes) embedded FLASH OTP Area */
#define FLASH_OTP_END \
	0x1FF07A0FUL /*!< End address of : (up to 528 Bytes) embedded FLASH OTP Area */
...
#define VREFINT_CAL_ADDR_CMSIS                                                                    \
	((uint16_t*)(0x1FF07A2A)) /*!<Internal voltage reference, address of parameter VREFINT_CAL:   \
...
#define TEMPSENSOR_CAL1_ADDR_CMSIS                                                                \
	((uint16_t*)(0x1FF07A2C)) /*!<Internal temperature sensor, address of parameter TS_CAL1: On   \
								 STM32F7, temperature sensor ADC raw data acquired at temperature \
								 30 DegC (tolerance: +-5 DegC), Vref+ = 3.3 V (tolerance: +-10    \
								 mV). */
#define TEMPSENSOR_CAL2_ADDR_CMSIS                                                                \
	((uint16_t*)(0x1FF07A2E)) /*!<Internal temperature sensor, address of parameter TS_CAL2: On   \
								 STM32F7, temperature sensor ADC raw data acquired at temperature \
...
#define DAC_CR_WAVE1 \
	DAC_CR_WAVE1_Msk /*!<WAVE1[1:0] (DAC channel1 noise/triangle wave generation enablEU) */
...
#define FMC_BWTR1_BUSTURN \
	FMC_BWTR1_BUSTURN_Msk /*!<BUSTURN[3:0] bits (Bus turnaround phase duration) */
...
#define FMC_BWTR2_BUSTURN \
	FMC_BWTR2_BUSTURN_Msk /*!<BUSTURN[3:0] bits (Bus turnaround phase duration) */
...
#define FMC_BWTR3_BUSTURN \
	FMC_BWTR3_BUSTURN_Msk /*!<BUSTURN[3:0] bits (Bus turnaround phase duration) */
...
#define FMC_BWTR4_BUSTURN \
	FMC_BWTR4_BUSTURN_Msk /*!<BUSTURN[3:0] bits (Bus turnaround phase duration) */
...
#define FMC_PMEM_MEMSET3                                                    \
	FMC_PMEM_MEMSET3_Msk /*!<MEMSET3[7:0] bits (Common memory 3 setup time) \
						  */
...
#define FMC_PMEM_MEMWAIT3 \
	FMC_PMEM_MEMWAIT3_Msk /*!<MEMWAIT3[7:0] bits (Common memory 3 wait time) */
...
#define FMC_PMEM_MEMHOLD3 \
	FMC_PMEM_MEMHOLD3_Msk /*!<MEMHOLD3[7:0] bits (Common memory 3 hold time) */
...
#define FMC_PMEM_MEMHIZ3 \
	FMC_PMEM_MEMHIZ3_Msk /*!<MEMHIZ3[7:0] bits (Common memory 3 databus HiZ time) */
...
#define FMC_PATT_ATTSET3 \
	FMC_PATT_ATTSET3_Msk /*!<ATTSET3[7:0] bits (Attribute memory 3 setup time) */
...
#define FMC_PATT_ATTWAIT3 \
	FMC_PATT_ATTWAIT3_Msk /*!<ATTWAIT3[7:0] bits (Attribute memory 3 wait time) */
...
#define FMC_PATT_ATTHOLD3 \
	FMC_PATT_ATTHOLD3_Msk /*!<ATTHOLD3[7:0] bits (Attribute memory 3 hold time) */
...
#define FMC_PATT_ATTHIZ3 \
	FMC_PATT_ATTHIZ3_Msk /*!<ATTHIZ3[7:0] bits (Attribute memory 3 databus HiZ time) */
...
#define PWR_CSR1_VOSRDY                                                       \
	PWR_CSR1_VOSRDY_Msk /*!< Regulator voltage scaling output selection ready \
						 */
...
#define PWR_CSR1_ODSWRDY \
	PWR_CSR1_ODSWRDY_Msk /*!< Over Drive Switch ready                          */
...
#define SDMMC_CMD_WAITPEND \
	SDMMC_CMD_WAITPEND_Msk /*!<CPSM Waits for ends of data transfer (CmdPend internal signal) */
...
#define SDMMC_RESP0_CARDSTATUS0_Msk                               \
	(0xFFFFFFFFUL << SDMMC_RESP0_CARDSTATUS0_Pos) /*!< 0xFFFFFFFF \
												   */
...
#define SDMMC_STA_TXFIFOHE                                                                        \
	SDMMC_STA_TXFIFOHE_Msk /*!<Transmit FIFO Half Empty: at least 8 words can be written into the \
							  FIFO */
...
#define SDMMC_MASK_SDIOITIE \
	SDMMC_MASK_SDIOITIE_Msk /*!<SDMMC Mode Interrupt Received interrupt Enable */
...
#define SDMMC_FIFOCNT_FIFOCOUNT                                                                 \
	SDMMC_FIFOCNT_FIFOCOUNT_Msk /*!<Remaining number of words to be written to or read from the \
								   FIFO */
...
#define SPI_I2SCFGR_I2SE \
	SPI_I2SCFGR_I2SE_Msk /*!<I2S Enable                                        */
...
#define TIM11_OR_TI1_RMP                                                     \
	TIM11_OR_TI1_RMP_Msk /*!<TI1_RMP[1:0] bits (TIM11 Input Capture 1 remap) \
						  */
...
#define DBGMCU_APB1_FZ_DBG_LPTIM1_STOP_Msk \
	(0x1UL << DBGMCU_APB1_FZ_DBG_LPTIM1_STOP_Pos) /*!< 0x00000200 */
...
#define USB_OTG_GUSBCFG_ULPI_UTMI_SEL_Msk \
	(0x1UL << USB_OTG_GUSBCFG_ULPI_UTMI_SEL_Pos) /*!< 0x00000010 */
#define USB_OTG_GUSBCFG_ULPI_UTMI_SEL \
	USB_OTG_GUSBCFG_ULPI_UTMI_SEL_Msk /*!< ULPI or UTMI+ Select (ULPI_UTMI_Sel) */
...
#define USB_OTG_GCCFG_DCDEN                                        \
	USB_OTG_GCCFG_DCDEN_Msk /*!< Data contact detection (DCD) mode \
							   enable*/
...
#define USB_HS_PHYC_PLL1_PLLSEL \
	USB_HS_PHYC_PLL1_PLLSEL_Msk /*!< Controls PHY frequency operation selection */
...
#define USB_HS_PHYC_PLL1_PLLSEL_12_5MHZ \
	USB_HS_PHYC_PLL1_PLLSEL_1 /*!< PHY PLL1 input clock frequency 12.5 MHz */
#define USB_HS_PHYC_PLL1_PLLSEL_16MHZ      \
	(uint32_t)(USB_HS_PHYC_PLL1_PLLSEL_1 | \
			   USB_HS_PHYC_PLL1_PLLSEL_2) /*!< PHY PLL1 input clock frequency 16 MHz   */
#define USB_HS_PHYC_PLL1_PLLSEL_24MHZ \
	USB_HS_PHYC_PLL1_PLLSEL_3 /*!< PHY PLL1 input clock frequency 24 MHz   */
#define USB_HS_PHYC_PLL1_PLLSEL_25MHZ      \
	(uint32_t)(USB_HS_PHYC_PLL1_PLLSEL_2 | \
			   USB_HS_PHYC_PLL1_PLLSEL_3) /*!< PHY PLL1 input clock frequency 25 MHz   */
...
#define USB_HS_PHYC_LDO_USED \
	USB_HS_PHYC_LDO_USED_Msk /*!< Monitors the usage status of the PHY's LDO   */
#define USB_HS_PHYC_LDO_STATUS_Pos (1U)
#define USB_HS_PHYC_LDO_STATUS_Msk (0x1UL << USB_HS_PHYC_LDO_STATUS_Pos) /*!< 0x00000002 */
#define USB_HS_PHYC_LDO_STATUS \
	USB_HS_PHYC_LDO_STATUS_Msk /*!< Monitors the status of the PHY's LDO.        */
#define USB_HS_PHYC_LDO_DISABLE_Pos (2U)
#define USB_HS_PHYC_LDO_DISABLE_Msk (0x1UL << USB_HS_PHYC_LDO_DISABLE_Pos) /*!< 0x00000004 */
#define USB_HS_PHYC_LDO_DISABLE \
	USB_HS_PHYC_LDO_DISABLE_Msk /*!< Controls disable of the High Speed PHY's LDO */
...
#define IS_ADC_ALL_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == ADC1) || ((__INSTANCE__) == ADC2) || ((__INSTANCE__) == ADC3))
...
#define IS_DMA_STREAM_ALL_INSTANCE(__INSTANCE__)                             \
	(((__INSTANCE__) == DMA1_Stream0) || ((__INSTANCE__) == DMA1_Stream1) || \
	 ((__INSTANCE__) == DMA1_Stream2) || ((__INSTANCE__) == DMA1_Stream3) || \
	 ((__INSTANCE__) == DMA1_Stream4) || ((__INSTANCE__) == DMA1_Stream5) || \
	 ((__INSTANCE__) == DMA1_Stream6) || ((__INSTANCE__) == DMA1_Stream7) || \
	 ((__INSTANCE__) == DMA2_Stream0) || ((__INSTANCE__) == DMA2_Stream1) || \
	 ((__INSTANCE__) == DMA2_Stream2) || ((__INSTANCE__) == DMA2_Stream3) || \
	 ((__INSTANCE__) == DMA2_Stream4) || ((__INSTANCE__) == DMA2_Stream5) || \
	 ((__INSTANCE__) == DMA2_Stream6) || ((__INSTANCE__) == DMA2_Stream7))

/******************************* GPIO Instances *******************************/
#define IS_GPIO_ALL_INSTANCE(__INSTANCE__)                                                  \
	(((__INSTANCE__) == GPIOA) || ((__INSTANCE__) == GPIOB) || ((__INSTANCE__) == GPIOC) || \
	 ((__INSTANCE__) == GPIOD) || ((__INSTANCE__) == GPIOE) || ((__INSTANCE__) == GPIOF) || \
	 ((__INSTANCE__) == GPIOG) || ((__INSTANCE__) == GPIOH) || ((__INSTANCE__) == GPIOI))
...
#define IS_I2C_ALL_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == I2C1) || ((__INSTANCE__) == I2C2) || ((__INSTANCE__) == I2C3))
...
#define IS_SAI_ALL_INSTANCE(__PERIPH__)                                  \
	(((__PERIPH__) == SAI1_Block_A) || ((__PERIPH__) == SAI1_Block_B) || \
	 ((__PERIPH__) == SAI2_Block_A) || ((__PERIPH__) == SAI2_Block_B))
/* Legacy define */
#define IS_SAI_BLOCK_PERIPH IS_SAI_ALL_INSTANCE

/******************************** SDMMC Instances *******************************/
#define IS_SDMMC_ALL_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == SDMMC1) || ((__INSTANCE__) == SDMMC2))

/******************************** SPI Instances *******************************/
#define IS_SPI_ALL_INSTANCE(__INSTANCE__)                                                \
	(((__INSTANCE__) == SPI1) || ((__INSTANCE__) == SPI2) || ((__INSTANCE__) == SPI3) || \
	 ((__INSTANCE__) == SPI4) || ((__INSTANCE__) == SPI5))

/****************** TIM Instances : All supported instances *******************/
#define IS_TIM_INSTANCE(__INSTANCE__)                                                       \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM3) ||    \
	 ((__INSTANCE__) == TIM4) || ((__INSTANCE__) == TIM5) || ((__INSTANCE__) == TIM6) ||    \
	 ((__INSTANCE__) == TIM7) || ((__INSTANCE__) == TIM8) || ((__INSTANCE__) == TIM9) ||    \
	 ((__INSTANCE__) == TIM10) || ((__INSTANCE__) == TIM11) || ((__INSTANCE__) == TIM12) || \
	 ((__INSTANCE__) == TIM13) || ((__INSTANCE__) == TIM14))

/****************** TIM Instances : supporting 32 bits counter ****************/
#define IS_TIM_32B_COUNTER_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM5))
...
#define IS_TIM_CC1_INSTANCE(__INSTANCE__)                                                  \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM3) ||   \
	 ((__INSTANCE__) == TIM4) || ((__INSTANCE__) == TIM5) || ((__INSTANCE__) == TIM8) ||   \
	 ((__INSTANCE__) == TIM9) || ((__INSTANCE__) == TIM10) || ((__INSTANCE__) == TIM11) || \
	 ((__INSTANCE__) == TIM12) || ((__INSTANCE__) == TIM13) || ((__INSTANCE__) == TIM14))

/************ TIM Instances : at least 2 capture/compare channels *************/
#define IS_TIM_CC2_INSTANCE(__INSTANCE__)                                                \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM3) || \
	 ((__INSTANCE__) == TIM4) || ((__INSTANCE__) == TIM5) || ((__INSTANCE__) == TIM8) || \
	 ((__INSTANCE__) == TIM9) || ((__INSTANCE__) == TIM12))
...
#define IS_TIM_DMA_INSTANCE(__INSTANCE__)                                                \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM8) || ((__INSTANCE__) == TIM2) || \
	 ((__INSTANCE__) == TIM3) || ((__INSTANCE__) == TIM4) || ((__INSTANCE__) == TIM5) || \
	 ((__INSTANCE__) == TIM6) || ((__INSTANCE__) == TIM7))
...
#define IS_TIM_COMBINED3PHASEPWM_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM8))
...
#define IS_TIM_OCXREF_CLEAR_INSTANCE(__INSTANCE__)                                       \
	(((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM3) || ((__INSTANCE__) == TIM4) || \
	 ((__INSTANCE__) == TIM5))
...
#define IS_TIM_MASTER_INSTANCE(__INSTANCE__)                                             \
	(((__INSTANCE__) == TIM1) || ((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM3) || \
	 ((__INSTANCE__) == TIM4) || ((__INSTANCE__) == TIM5) || ((__INSTANCE__) == TIM6) || \
	 ((__INSTANCE__) == TIM7) || ((__INSTANCE__) == TIM8))
...
#define IS_TIM_REMAP_INSTANCE(__INSTANCE__) \
	(((__INSTANCE__) == TIM2) || ((__INSTANCE__) == TIM5) || ((__INSTANCE__) == TIM11))
...
#define IS_TIM_CCX_INSTANCE(__INSTANCE__, __CHANNEL__)                           \
	((((__INSTANCE__) == TIM1) &&                                                \
	 ...
	 (((__INSTANCE__) == TIM9) &&                                                \
	  (((__CHANNEL__) == TIM_CHANNEL_1) || ((__CHANNEL__) == TIM_CHANNEL_2))) || \
	 (((__INSTANCE__) == TIM10) && (((__CHANNEL__) == TIM_CHANNEL_1))) ||        \
	 (((__INSTANCE__) == TIM11) && (((__CHANNEL__) == TIM_CHANNEL_1))) ||        \
	 (((__INSTANCE__) == TIM12) &&                                               \
	  (((__CHANNEL__) == TIM_CHANNEL_1) || ((__CHANNEL__) == TIM_CHANNEL_2))) || \
	 (((__INSTANCE__) == TIM13) && (((__CHANNEL__) == TIM_CHANNEL_1))) ||        \
	 (((__INSTANCE__) == TIM14) && (((__CHANNEL__) == TIM_CHANNEL_1))))
...
#define IS_USART_INSTANCE(__INSTANCE__)                                                        \
	(((__INSTANCE__) == USART1) || ((__INSTANCE__) == USART2) || ((__INSTANCE__) == USART3) || \
	 ((__INSTANCE__) == USART6))

/******************** UART Instances : Asynchronous mode **********************/
#define IS_UART_INSTANCE(__INSTANCE__)                                                         \
	(((__INSTANCE__) == USART1) || ((__INSTANCE__) == USART2) || ((__INSTANCE__) == USART3) || \
	 ((__INSTANCE__) == UART4) || ((__INSTANCE__) == UART5) || ((__INSTANCE__) == USART6) ||   \
	 ((__INSTANCE__) == UART7) || ((__INSTANCE__) == UART8))
