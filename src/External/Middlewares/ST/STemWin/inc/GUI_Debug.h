...
*/
	...
	#define GUI_DEBUG_LEVEL_LOG_ALL 5 /* Errors, Warnings and Messages are recorded. */
			...
			#define GUI_DEBUG_LEVEL \
				GUI_DEBUG_LEVEL_LOG_WARNINGS /* Simulation should log all warnings */
		#else
			#define GUI_DEBUG_LEVEL \
				GUI_DEBUG_LEVEL_NOCHECK /* For most targets, min. size is important */
		#endif
	#endif
