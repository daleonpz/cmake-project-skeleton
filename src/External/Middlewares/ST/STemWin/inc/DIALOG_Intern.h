...
{ // Make sure we have C-declarations in C++ programs
	...
	typedef WM_HWIN GUI_WIDGET_CREATE_FUNC(const GUI_WIDGET_CREATE_INFO* pCreate, WM_HWIN hWin,
	...
	struct GUI_WIDGET_CREATE_INFO_struct
	{
		...
		U32 NumExtraBytes; // Number of extra bytes usable with <WIDGET>_SetUserData &
						   // <WIDGET>_GetUserData
	};
	 ...
	 **********************************************************************
	 */
	WM_HWIN GUI_CreateDialogBox(const GUI_WIDGET_CREATE_INFO* paWidget, int NumWidgets,
								WM_CALLBACK* cb, WM_HWIN hParent, int x0, int y0);
	void GUI_EndDialog(WM_HWIN hWin, int r);
	int GUI_ExecDialogBox(const GUI_WIDGET_CREATE_INFO* paWidget, int NumWidgets, WM_CALLBACK* cb,
	...
	void GUI_SetDialogStatusPtr(WM_HWIN hDialog,
								WM_DIALOG_STATUS* pDialogStatus); // Not to be documented
