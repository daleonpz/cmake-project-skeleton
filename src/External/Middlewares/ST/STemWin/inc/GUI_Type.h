...
typedef struct
{
	void (*pfDraw)(int x0, int y0, int xsize, int ysize, const U8* pPixel,
				   const LCD_LOGPALETTE* pLogPal, int xMag, int yMag);
	GUI_COLOR (*pfIndex2Color)(LCD_PIXELINDEX Index);
	void (*pfDrawHW)(int x0, int y0, int xsize, int ysize, const U8* pPixel,
					 const LCD_LOGPALETTE* pLogPal, int xMag, int yMag);
...
{ /* Make sure we have C-declarations in C++ programs */
	...
	#define GUI_FONTTYPE_MONO                                                          \
		GUIMONO_DispChar, GUIMONO_GetCharDistX, GUIMONO_GetFontInfo, GUIMONO_IsInFont, \
			(GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0

	/* PROP: Proportional fonts */
	#define GUI_FONTTYPE_PROP                                                          \
		GUIPROP_DispChar, GUIPROP_GetCharDistX, GUIPROP_GetFontInfo, GUIPROP_IsInFont, \
			(GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0

	/* PROP_EXT: Extended proportional fonts */
	#define GUI_FONTTYPE_PROP_EXT                                                \
		GUIPROP_EXT_DispChar, GUIPROP_EXT_GetCharDistX, GUIPROP_EXT_GetFontInfo, \
			GUIPROP_EXT_IsInFont, GUIPROP_EXT_GetCharInfo, &GUI_ENC_APIList_EXT

	/* PROP_FRM: Extended proportional fonts, framed */
	#define GUI_FONTTYPE_PROP_FRM                                                \
		GUIPROP_FRM_DispChar, GUIPROP_FRM_GetCharDistX, GUIPROP_FRM_GetFontInfo, \
			GUIPROP_FRM_IsInFont, (GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0
	...
	#define GUI_FONTTYPE_PROPAA                                                                \
		GUIPROPAA_DispChar, GUIPROPAA_GetCharDistX, GUIPROPAA_GetFontInfo, GUIPROPAA_IsInFont, \
			(GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0

	/* PROP_AA2: Proportional, antialiased fonts, 2bpp */
	#define GUI_FONTTYPE_PROP_AA2                                                \
		GUIPROP_AA2_DispChar, GUIPROP_AA2_GetCharDistX, GUIPROP_AA2_GetFontInfo, \
			GUIPROP_AA2_IsInFont, (GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0

	/* PROP_AA2_EXT: Proportional, antialiased fonts, 2bpp, extended font information */
	#define GUI_FONTTYPE_PROP_AA2_EXT                                                \
		GUIPROP_AA2_EXT_DispChar, GUIPROP_EXT_GetCharDistX, GUIPROP_EXT_GetFontInfo, \
			GUIPROP_EXT_IsInFont, GUIPROP_EXT_GetCharInfo, &GUI_ENC_APIList_EXT

	/* PROP_AA2: Proportional, antialiased fonts, 2bpp, SJIS encoding */
	#define GUI_FONTTYPE_PROP_AA2_SJIS                                           \
		GUIPROP_AA2_DispChar, GUIPROP_AA2_GetCharDistX, GUIPROP_AA2_GetFontInfo, \
			GUIPROP_AA2_IsInFont, (GUI_GETCHARINFO*)0, &GUI_ENC_APIList_SJIS

	/* PROP_AA4: Proportional, antialiased fonts, 4bpp */
	#define GUI_FONTTYPE_PROP_AA4                                                \
		GUIPROP_AA4_DispChar, GUIPROP_AA4_GetCharDistX, GUIPROP_AA4_GetFontInfo, \
			GUIPROP_AA4_IsInFont, (GUI_GETCHARINFO*)0, (tGUI_ENC_APIList*)0

	/* PROP_AA4_EXT: Proportional, antialiased fonts, 4bpp, extended font information */
	#define GUI_FONTTYPE_PROP_AA4_EXT                                                \
		GUIPROP_AA4_EXT_DispChar, GUIPROP_EXT_GetCharDistX, GUIPROP_EXT_GetFontInfo, \
			GUIPROP_EXT_IsInFont, GUIPROP_EXT_GetCharInfo, &GUI_ENC_APIList_EXT

	/* PROP_AA4: Proportional, antialiased fonts, 4bpp, SJIS encoding */
	#define GUI_FONTTYPE_PROP_AA4_SJIS                                           \
		GUIPROP_AA4_DispChar, GUIPROP_AA4_GetCharDistX, GUIPROP_AA4_GetFontInfo, \
			GUIPROP_AA4_IsInFont, (GUI_GETCHARINFO*)0, &GUI_ENC_APIList_SJIS
...
typedef struct
{
	...
	int PixelHeight; /* Pixel height of new font. It means the height of the surrounding rectangle
					  ...
					  * between two lines of text. With other words the value returned
					  * byGUI_GetFontSizeY() is not identically with this value. */
	int FaceIndex; /* Some font files can contain more than one font face. In case of more than one
					* face this index specifies the zero based face index to be used to create the
					* font. Usually 0. */
} GUI_TTF_CS;
