...
{ /* Make sure we have C-declarations in C++ programs */
	...
	HEADER_Handle HEADER_Create(int x0, int y0, int xSize, int ySize, WM_HWIN hParent, int Id,
	...
	void HEADER_SetBitmapEx(HEADER_Handle hObj, unsigned int Index, const GUI_BITMAP* pBitmap,
							int x, int y);
	...
	void HEADER_SetDirIndicator(HEADER_Handle hObj, int Column,
								int Reverse); /* !!!Not to be documented!!! */
	...
	void HEADER_SetStreamedBitmap(HEADER_Handle hObj, unsigned int Index,
								  const GUI_BITMAP_STREAM* pBitmap);
	void HEADER_SetStreamedBitmapEx(HEADER_Handle hObj, unsigned int Index,
